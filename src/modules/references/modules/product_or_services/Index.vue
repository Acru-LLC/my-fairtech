                ...
                <div class="card-body">
                                ...
                                <b-row>
                                    ...
                                    <b-col cols="5">
                                        <b-btn
                                            ...
                                            :to="{name: 'CreateProductOrService', params: {cStatusId: contractorStatuses[activeTabIndex].code.toLowerCase()}}"
                                        >
                        ...
                        >
                            ...
                            >
                                ...
                                <template #cell(index)="data">
                                    {{ util_paginate(data.index, paginations[index].page, paginations[index].itemsPerPage) }}
                                </template>
                  ...
                  getName({
                    ...
                    nameUz: data.item.directoryProductOrServiceTypeNameUz,
                            ...
                            <!-- end table -->
                            <b-pagination
                                :key="`tab-pagination-${index}`"
                                v-model="paginations[index].page"
                                @input="fetchTableItems(activeTabIndex)"
                                :total-rows="paginations[index].totalItems"
                                :per-page="paginations[index].itemsPerPage"
