    ...
    <div class="row">
        <div class="col-12">
          <div class="col-md-12 text-center">
            <div class="h4 mb-4 d-inline-block">{{ $t('column.oked') }}</div>
          </div>
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                                    ...
                                    <b-col cols="7">
                                        <div class="text-sm-end">
                                            <download-excel
                                                :data="json_data"
                                                :fields="json_fields"
                                                :header="$t('column.oked')"
                                                worksheet="My Worksheet"
                                                :name="`${$t('column.oked')}.xls`"
                                            >
                                                <b-btn
                                                    @click="downloadExcel"
                                                    type="button"
...
<script>
const MAIN_API_URL = 'reestr/info-oked'
...
export default {
    ...
    methods: {
        ...
        editItem (id) {
            this.$router.push({ name: 'UpdateOked', params: { id: id } })
        },
        deleteItem (id) {
