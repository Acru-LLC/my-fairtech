  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.commission.special_commission_type.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
                ...
                <b-row>
                  ...
                  <b-col cols="5">
                    <b-btn
                        ...
                        :to="{name: 'CreatespecialCommissionType'}"
                    >
          ...
          >
            ...
            <template #row-details="row">
              <div class="row m-0" style="background-color: #dae0ff;"
                   v-for="(item, key) in row.item.directoryCommissionEmployeeDto" :key="key">
                <div class="col-md-6 p-2 border-top border-secondary">
                  <b style="font-weight: 900">{{ item.employeeDto.fullName }}</b>
                  <br>
                  {{
                    getName({
                      nameUz: item.employeeDto.departmentParentNameUz,
                      nameLt: item.employeeDto.departmentParentNameLt,
                      nameRu: item.employeeDto.departmentParentNameRu
                    })
                  }} / {{
                    getName({
                      nameUz: item.employeeDto.departmentNameUz,
                      nameLt: item.employeeDto.departmentNameLt,
                      nameRu: item.employeeDto.departmentNameRu
                    })
                  }} <br>
                  {{
                    getName({
                      nameUz: item.employeeDto.directoryPositionNameUz,
                      nameLt: item.employeeDto.directoryPositionNameLt,
                      nameRu: item.employeeDto.directoryPositionNameRu
                    })
                  }}
                </div>
                <div class="col-md-6 p-2 border-top border-secondary">
                  {{
                    getName({
                      nameUz: item.commissionPositionNameUz,
                      nameLt: item.commissionPositionNameLt,
                      nameRu: item.commissionPositionNameRu
                    })
                  }}
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdatespecialCommissionType', params: {id: id}})
    },
    deleteItem(id) {
