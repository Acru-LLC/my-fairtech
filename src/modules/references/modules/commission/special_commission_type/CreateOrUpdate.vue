<template>
  ...
  >
    <CreatespecialCommissionType ref="formDepartmentTypes"></CreatespecialCommissionType>
  </base-create-or-update-wrapper>
</template>
<script>
import CreatespecialCommissionType from "@/shared/views/components/CreatespecialCommissionType";
