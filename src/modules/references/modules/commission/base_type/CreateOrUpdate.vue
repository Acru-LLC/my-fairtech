<template>
  ...
  >
    <CreateBaseType ref="formDepartmentTypes"></CreateBaseType>
  </base-create-or-update-wrapper>
</template>
<script>
import CreateBaseType from "@/shared/views/components/commission/references/CreateBaseType";

const MAIN_API_URL = 'directory/application/base'
/*
...
export default {
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.$route.name === 'CreateBaseType'
    },
    computedObserver() {
