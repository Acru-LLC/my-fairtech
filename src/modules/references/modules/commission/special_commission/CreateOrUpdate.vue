<template>
  ...
  >
    <CreatespecialCommission ref="formDepartmentTypes"></CreatespecialCommission>
  </base-create-or-update-wrapper>
</template>
<script>
import CreatespecialCommission from "@/shared/views/components/CreatespecialCommission";

const MAIN_API_URL = 'directory/commission/commission-position'
/*
...
export default {
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.$route.name === 'CreatespecialCommission'
    },
    computedObserver() {
