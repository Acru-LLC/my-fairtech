<template>
  ...
  >
    <CreatecompetitionLawArticle ref="formDepartmentTypes"></CreatecompetitionLawArticle>
  </base-create-or-update-wrapper>
</template>
<script>
import CreatecompetitionLawArticle from "@/shared/views/components/CreatecompetitionLawArticle";

const MAIN_API_URL = 'directory/commission/competition-law'
/*
...
export default {
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.$route.name === 'CreateComplainant'
    },
    computedObserver() {
