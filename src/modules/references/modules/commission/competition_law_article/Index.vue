  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.commission.competition_law_article.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
                ...
                <b-row>
                  ...
                  <b-col cols="5">
                    <b-btn
                        ...
                        :to="{name: 'CreatecompetitionLawArticle'}"
                    >
...
export default {
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdatecompetitionLawArticle', params: {id: id}})
    },
    deleteItem(id) {
