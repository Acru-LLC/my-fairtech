<template>
  ...
  >
    <CreateAppealType ref="formDepartmentTypes"></CreateAppealType>
  </base-create-or-update-wrapper>
</template>
<script>
import CreateAppealType from "@/shared/views/components/commission/references/CreateAppealType";

const MAIN_API_URL = 'directory/application/appeal-type'
/*
...
export default {
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.$route.name === 'CreateAppealType'
    },
    computedObserver() {
