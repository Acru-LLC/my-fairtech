<template>
  ...
  >
    <CreateDocumentStatus ref="formDepartmentTypes"></CreateDocumentStatus>
  </base-create-or-update-wrapper>
</template>
<script>
import CreateDocumentStatus from "@/shared/views/components/commission/references/CreateDocumentStatus";
const MAIN_API_URL = 'directory/application/document-status'
/*
...
export default {
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.$route.name === 'CreateCommissionDocumentStatus'
    },
    computedObserver() {
