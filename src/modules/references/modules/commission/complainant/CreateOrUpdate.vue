<template>
  ...
  >
    <CreateFormComplainant ref="formDepartmentTypes"></CreateFormComplainant>
  </base-create-or-update-wrapper>
</template>
<script>
import CreateFormComplainant from "@/shared/views/components/CreateFormComplainant";

const MAIN_API_URL = 'directory/commission/complainant-type'
/*
