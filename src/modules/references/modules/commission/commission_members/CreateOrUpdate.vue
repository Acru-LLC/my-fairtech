<template>
  ...
  >
    <CreatecommissionMembers ref="formDepartmentTypes"></CreatecommissionMembers>
  </base-create-or-update-wrapper>
</template>
<script>
import CreatecommissionMembers from "@/shared/views/components/CreatecommissionMembers";
