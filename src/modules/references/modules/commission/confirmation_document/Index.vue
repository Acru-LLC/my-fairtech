  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.commission.confirmation_document.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
                ...
                <b-row>
                  ...
                  <b-col cols="5">
                    <b-btn
                        ...
                        :to="{name: 'CreateconfirmationDocument'}"
                    >
...
export default {
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateconfirmationDocument', params: {id: id}})
    },
    deleteItem(id) {
