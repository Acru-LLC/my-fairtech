<template>
  ...
  >
    <CreateconfirmationDocument ref="formDepartmentTypes"></CreateconfirmationDocument>
  </base-create-or-update-wrapper>
</template>
<script>
import CreateconfirmationDocument from "@/shared/views/components/CreateconfirmationDocument";

const MAIN_API_URL = 'directory/commission/confirmation-document'
/*
