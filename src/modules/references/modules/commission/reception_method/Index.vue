  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.commission.reception_method.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
...
export default {
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateReceptionMethod', params: {id: id}})
    },
    deleteItem(id) {
