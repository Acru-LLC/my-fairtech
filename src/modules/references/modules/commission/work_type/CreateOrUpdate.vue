<template>
  ...
  >
    <CreateworkType ref="formDepartmentTypes"></CreateworkType>
  </base-create-or-update-wrapper>
</template>
<script>
import CreateworkType from "@/shared/views/components/CreateworkType";

const MAIN_API_URL = 'directory/commission/work-type'
/*
