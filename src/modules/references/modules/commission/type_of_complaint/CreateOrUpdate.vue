<template>
  ...
  >
    <CreateComplainantOfType ref="formDepartmentTypes"></CreateComplainantOfType>
  </base-create-or-update-wrapper>
</template>
<script>
import CreateComplainantOfType from "@/shared/views/components/CreateFormComplaintOfType";

const MAIN_API_URL = 'directory/commission/complaint-type'
/*
...
export default {
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.$route.name === 'CreateTypeOfComplaint'
    },
    computedObserver() {
