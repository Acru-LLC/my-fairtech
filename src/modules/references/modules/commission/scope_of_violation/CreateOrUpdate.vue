<template>
  ...
  >
    <CreatescopeOfViolation ref="formDepartmentTypes"></CreatescopeOfViolation>
  </base-create-or-update-wrapper>
</template>
<script>
import CreatescopeOfViolation from "@/shared/views/components/CreatescopeOfViolation";

const MAIN_API_URL = 'directory/commission/violation-scope'
/*
