  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.quarters.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2 bootstrap-5-row">
            <div class="col-sm-8">
                ...
                <b-row>
                  ...
                  <b-col cols="5">
                    <b-btn
                        ...
                        :to="{name: 'CreateGeoRegionQuarter'}"
                    >
            ...
            <!-- end col-->
              ...
              <b-row class="mb-2 bootstrap-5-row">
                <b-col cols="4">
                  <!-- REGIONS -->
...
export default {
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateGeoRegionQuarter', params: {id: id}})
    },
    deleteItem(id) {
