    ...
    <div class="row">
        <div class="col-12">
          <div class="col-md-12 text-center">
            <div class="h4 mb-4 d-inline-block">{{ $t('column.coefficient') }}</div>
          </div>
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-4">
                            <div class="text-sm-end">
                                <b-btn
                                    ...
                                    :to="{name: 'CreateAdvertisementPrivilegeCoefficient'}"
                                >
                    ...
                    >
                        ...
                        <template #cell(adDesignTypes)="data">
                            <div class="d-flex align-items-center flex-wrap">
                                <ul>
                                    <li
                                        v-for="(design, index) in data.item.directoryAdvertisementDesignTypes"
                    ...
                    nameUz: data.item.statusNameUz,
                        ...
                        <template #cell(actions)="data">
                            <div class="general-table__actions d-flex justify-content-center">
                                ...
                                <b-btn
                                    v-if="data.item.statusNameEn == 'ACTIVE'"
                                    variant="link"
...
export default {
    ...
    methods: {
        ...
        editItem (id) {
            this.$router.push({ name: 'UpdateAdvertisementPrivilegeCoefficient', params: { id: id } })
        },
        deleteItem (id) {
