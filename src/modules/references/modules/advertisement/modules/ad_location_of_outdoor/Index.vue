  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.ad_volume_types_by_location_of_outdoor.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
                ...
                <b-row>
                  <b-col cols="7">
                    <div class="text-sm-end">
                      <download-excel
                          :data="json_data"
                          :fields="json_fields"
                          header="Ташқи реклама объекти жойлашган ер"
                          worksheet="My Worksheet"
                          name="Ташқи_реклама_объекти_жойлашган_ер.xls"
                      >
                        <b-btn
                            @click="downloadExcel"
                            type="button"
                  ...
                  <b-col cols="5">
                    <b-btn
                        ...
                        :to="{name: 'CreateAdvertisementLocationOfOutdoor'}"
                    >
          ...
          <!-- <b-form-select
              ...
              v-model="var_default_search_payload.itemsPerPage"
              size="sm"
              :options="pageOptions"
          ></b-form-select> -->
...
export default {
  page: {
    title: "Advertisement Location Of Outdoor",
  ...
  methods: {
    downloadExcel() {
      ...
      this.tableItems.forEach(res => {
        ...
        obj.statusNameUz = res.statusNameUz
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateAdvertisementLocationOfOutdoor', params: {id: id}})
    },
    deleteItem(id) {
  ...
  watch: {
    ...
    /* 'var_default_search_payload.itemsPerPage': {
        handler () {
            this.fetchTableItems()
        }
    } */
