            ...
            <div class="col-sm-4">
              <div class="text-sm-end">
                <b-btn
                    ...
                    :to="{name: 'CreateMinimumCollectionType'}"
                >
...
export default {
  page: {
    title: "Minimum Collection types",
  ...
  methods: {
    ...
    fetchTableItems() {
      ...
      if (this.util_current_locale == 'uz') {
        this.var_default_search_payload.sortBy.push('nameLt')
      } else if (this.util_current_locale == 'ru') {
        this.var_default_search_payload.sortBy.push('nameRu')
      } else if (this.util_current_locale == 'uzCyrillic') {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateMinimumCollectionType', params: {id: id}})
    },
    deleteItem(id) {
