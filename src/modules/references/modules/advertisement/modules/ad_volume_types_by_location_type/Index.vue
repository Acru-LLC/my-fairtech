    ...
    <div class="row">
        <div class="col-12">
          <div class="col-md-12 text-center">
            <div class="h4 mb-4 d-inline-block">{{ $t('submodules.ad_volume_types_by_location_type.title') }}</div>
          </div>
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-4">
                            <div class="text-sm-end">
                                <b-btn
                                    ...
                                    :to="{name: 'CreateAdvertisementVolumeTypesByLocationType'}"
                                >
                    ...
                    nameUz: data.item.directoryAdvertisementLocationTypeNameUz,
                        ...
                        <!-- AD_VOLUME_TYPES -->
                        <template #cell(adVolumeTypes)="data">
                            <div class="d-flex align-items-center flex-wrap">
                                <ul>
                                    <li
                                        v-for="(volume, index) in data.item.volumeTypes"
                                        :key="`location-volume-${index}`"
                                    >{{
                                        getName({
                                          nameRu: volume.nameRu,
                                          nameLt: volume.nameLt,
                                          nameUz: volume.nameUz,
                                        })
                                      }}</li>
                                </ul>
                            </div>
                        ...
                        <template #cell(actions)="data">
                            <div class="general-table__actions d-flex justify-content-center">
                                ...
                                >
                                    <i
                                        @click="editItem(data.item.directoryAdvertisementLocationTypeId)"
                                ...
                                >
                                    <i
                                        @click="deleteItem(data.item.directoryAdvertisementLocationTypeId)"
...
export default {
    ...
    data () {
        return {
            ...
            tableFields: [
                ...
                { label: this.$t('submodules.ad_volume_types.title_plural'), key: "adVolumeTypes" },
                {
    ...
    methods: {
        ...
        editItem (id) {
            this.$router.push({ name: 'UpdateAdvertisementVolumeTypesByLocationType', params: { id: id } })
        },
        deleteItem (id) {
