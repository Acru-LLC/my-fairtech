  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.advertisement.ad_object_state') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
            <div class="col-sm-8">
              ...
              <div class="col-2 me-2 mx-1 d-inline-block">
                <div class="position-relative">
                  <b-form-select
                      v-model="selected"
                ...
                <b-row>
                  <b-col cols="7">
                    <div class="text-sm-end">
                      <download-excel
                          :data="json_data"
                          :fields="json_fields"
                          header="Объект холати"
                          worksheet="My Worksheet"
                          name="Объект_холати.xls"
                      >
                        <b-btn
                            @click="downloadExcel"
                            type="button"
                  ...
                  <b-col cols="5">
                    <b-btn
                        ...
                        :to="{name: 'CreateAdvertisementObjectState'}"
                    >
...
export default {
  page: {
    title: "Advertisement Object States",
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateAdvertisementObjectState', params: {id: id}})
    },
    deleteItem(id) {
