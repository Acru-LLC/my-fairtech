  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.advertisement.ad_zones') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
                ...
                <b-row>
                  <b-col cols="7">
                    <div class="text-sm-end">
                      <download-excel
                          :data="json_data"
                          :fields="json_fields"
                          header="Худудий зоналар"
                          worksheet="My Worksheet"
                          name="Худудий_зоналар.xls"
                      >
                        <b-btn
                            @click="downloadExcel"
                            type="button"
                  ...
                  <b-col cols="5">
                    <b-btn
                        ...
                        :to="{name: 'CreateAdvertisementZone'}"
                    >
...
export default {
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateAdvertisementZone', params: {id: id}})
    },
    deleteItem(id) {
