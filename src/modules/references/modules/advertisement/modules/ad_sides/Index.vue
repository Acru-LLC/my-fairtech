  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.advertisement.ad_sides') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
                ...
                <b-row>
                  <b-col cols="7">
                    <div class="text-sm-end">
                      <download-excel
                          :data="json_data"
                          :fields="json_fields"
                          header="Ташқи реклама объекти томонлар сони"
                          worksheet="My Worksheet"
                          name="Ташқи_реклама_объекти_томонлар_сони.xls"
                      >
                        <b-btn
                            @click="downloadExcel"
                            type="button"
                  ...
                  <b-col cols="5">
                    <b-btn
                        ...
                        :to="{name: 'CreateAdvertisementSide'}"
                    >
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        ...
        [this.$t('column.number_of_parties')]: "code",
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {label: this.$t('column.number_of_parties'), key: "code"},
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateAdvertisementSide', params: {id: id}})
    },
    deleteItem(id) {
