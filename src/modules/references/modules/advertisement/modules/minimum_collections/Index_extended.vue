        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <div class="search-box me-5 mb-2 d-inline-block">
...
const MAIN_API_URL = 'directory/extended-minimum-collections'
...
export default {
    ...
    data () {
        return {
            ...
            tableFields: [
                ...
                { label: this.$t('column.decision_number'), key: "directoryMinimumCollectionDto.decisionNumber" },
                { label: this.$t('column.ad_location_type'), key: "directoryMinimumCollectionDto.directoryAdvertisementLocationTypeNameUz" },
                { label: this.$t('column.ad_design_type'), key: "directoryMinimumCollectionDto.directoryAdvertisementDesignTypeNameUz" },
                { label: this.$t('column.region'), key: "directoryMinimumCollectionDto.regionName" },
                { label: this.$t('submodules.minimum_collection_types.title'), key: "directoryMinimumCollectionTypeNameUz" },
                { label: this.$t('column.unit'), key: "directoryMinimumCollectionDto.unitShortNameUz" },
                { label: this.$t('column.minimum_collection'), key: "cost" },
                { label: this.$t('column.status'), key: "statusNameUz" },
                { label: this.$t('column.reason'), key: "directoryMinimumCollectionDto.description" },
                {
    ...
    methods: {
        ...
        editItem (id) {
            this.$router.push({ name: 'UpdateMinimumCollectionExtended', params: { id: id } })
        },
        deleteItem (id) {
