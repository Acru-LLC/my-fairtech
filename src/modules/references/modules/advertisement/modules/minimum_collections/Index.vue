  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.advertisement.minimum_collection') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
                ...
                <b-row>
                  <b-col cols="7">
                    <div class="text-sm-end">
                      <download-excel
                          :data="json_data"
                          :fields="json_fields"
                          header="Минимал йиғим 1 кв/м учун"
                          worksheet="My Worksheet"
                          name="Минимал_йиғим_1_кв/м_учун.xls"
                      >
                        <b-btn
                            @click="downloadExcel"
                            type="button"
                  ...
                  <b-col cols="5">
                    <b-btn
                        ...
                        :to="{name: 'CreateMinimumCollection'}"
                    >
          ...
          >
            ...
            <template #cell(costs)="data">
              <p>
                {{ getNumberFormat(data.item.cost) }}
              </p>
            </template>
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        "Қарор санаси": "decisionDate",
        "Қарор рақами": "decisionNumber",
        "Ташки реклама объекти (конструкцияси) жойлашуви": "directoryAdvertisementLocationTypeNameUz",
        "Реклама конструкцияси номи": "directoryAdvertisementDesignTypeNameUz",
        "Вилоят": "regionName",
        "Туман": "districtName",
        "Ўлчов бирлиги": "unitNameUz",
        "Минимал йиғим (М)": "cost",
        "Киритилган сана": "createdDate",
        "Асос": "description",
      },
      json_data: [],
      json_meta: [
      ...
      tableFields: [
        ...
        {label: this.$t('column.decision_date'), key: "decisionDate"},
        {label: this.$t('column.decision_number'), key: "decisionNumber"},
        ...
        // { label:this.$t('submodules.minimum_collection_types.title'), key: "directoryMinimumCollectionTypeNameUz" },
        {label: this.$t('column.unit'), key: "unitShortNameUz"},
        {label: this.$t('column.minimum_collection'), key: "costs"},
        {label: this.$t('column.created_date'), key: "createdDate"},
  ...
  methods: {
    downloadExcel() {
      ...
      this.tableItems.forEach(res => {
        let obj = {}
        obj.decisionDate = res.decisionDate
        obj.decisionNumber = res.decisionNumber
        obj.directoryAdvertisementLocationTypeNameUz = res.directoryAdvertisementLocationTypeNameUz
        obj.directoryAdvertisementDesignTypeNameUz = res.directoryAdvertisementDesignTypeNameUz
        obj.regionName = res.regionName
        obj.districtName = res.districtName
        obj.unitNameUz = res.unitNameUz
        obj.cost = res.cost
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateMinimumCollection', params: {id: id}})
    },
    deleteItem(id) {
