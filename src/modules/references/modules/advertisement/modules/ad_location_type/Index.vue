  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.advertisement.location_type') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
                ...
                <b-row>
                  ...
                  <b-col cols="5">
                    <b-btn
                        ...
                        :to="{name: 'CreateAdvertisementLocationType'}"
                    >
...
export default {
  page: {
    title: "Advertisement Location Type",
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateAdvertisementLocationType', params: {id: id}})
    },
    deleteItem(id) {
