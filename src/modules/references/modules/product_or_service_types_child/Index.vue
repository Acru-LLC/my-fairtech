        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-sm-4">
                            <div class="text-sm-end">
                                <b-row>
                                    ...
                                    <b-col cols="5">
                                        <b-btn
                                            v-if="activeTabIndex > -1 && filteredContractorStatuses.length"
                                            type="button"
                                            class="btn btn-success btn-rounded mb-2 me-2"
                                            :to="{name: 'CreateProductOrServiceTypeChild', params: {cStatusId: filteredContractorStatuses[activeTabIndex].id}}"
                                        >
                    ...
                    >
                        <b-tab
                            v-for="(cStatus, index) in filteredContractorStatuses"
...
<script>
const MAIN_API_URL = 'directory/product-or-service-type-children'
...
export default {
    page: {
        title: "Product Or Service Types child",
    ...
    computed: {
        ...
        filteredContractorStatuses () {
            return this.contractorStatuses.filter(el => el.code == 'DAMINIRIUSHIY')
        }
    },
    methods: {
        downloadExcel () {
        ...
        fetchTableItems (tabIndex) {
            ...
            if (this.filteredContractorStatuses.length) {
                ...
                crudAndListsService
                    .searchListWithKeyword(MAIN_API_URL, this.var_default_search_payload, this.filteredContractorStatuses[this.activeTabIndex].code.toLowerCase(), true)
                    .then((res) => {
        ...
        editItem (id) {
            this.$router.push({ name: 'UpdateProductOrServiceTypeChild', params: { id: id } })
        },
        deleteItem (id) {
