    ...
    <div class="row">
        <div class="col-12">
          <div class="col-md-12 text-center">
            <div class="h4 mb-4 d-inline-block">{{ $t('column.group_of_individuals') }}</div>
          </div>
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-8">
                            ...
                            <div class="me-2 mx-2 d-inline-block">
                                <div class="position-relative">
                                    <b-form-select
                                        v-model="selected"
                                ...
                                <b-row>
                                    ...
                                    <b-col cols="12" class="text-end">
                                        <b-btn
                                            ...
                                            :to="{name: 'CreateGroupOfIndividuals'}"
                                        >
...
export default {
    ...
    data () {
        return {
            ...
            tableFields: [
                ...
                { label: this.$t('column.share_percentage'), key: "percentage" },
                {
    ...
    methods: {
        ...
        editItem (id) {
            this.$router.push({ name: 'UpdateGroupOfIndividuals', params: { id: id } })
        },
        deleteItem (id) {
