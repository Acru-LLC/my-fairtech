  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.mailing_purpose.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
          ...
          >
            ...
            <!-- PROCESSES -->
            <template #cell(processes)="data">
                <div class="d-flex align-items-center flex-wrap">
                    <ul>
                        <li
                            v-for="(p, index) in data.item.processDtos"
                            :key="`process-${index}`"
                        >{{
                            getName({
                              nameRu: p.nameRu,
...
export default {
  ...
  data() {
    return {
      ...
      tableFields: [
        ...
        {label: this.$t('column.code'), key: "orderCode"},
        {label: this.$t('submodules.process.title_plural'), key: "processes"},
        {
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateMailingPurpose', params: {id: id}})
    },
    deleteItem(id) {
