        ...
        <div class="col-12">
            <div class="card">
              <div class="ml-5 mt-3 mb-0" style="text-align: center">
                <h4> {{ $t('submodules.product_or_services_daminiriushiy.title') }}</h4>
              </div>
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-8">
                                ...
                                <b-row>
                                    ...
                                    <b-col cols="5">
                                        <b-btn
                                            ...
                                            :to="{name: 'CreateProductOrServiceDaminiriushiy', params: {cStatusId: contractorStatuses[activeTabIndex].code.toLowerCase()}}"
                                        >
...
export default {
    ...
    methods: {
        ...
        editItem (id) {
            this.$router.push({ name: 'UpdateProductOrService', params: { id: id, cStatusId: this.contractorStatuses[this.activeTabIndex].code.toLowerCase() } })
        },
        deleteItem (id) {
