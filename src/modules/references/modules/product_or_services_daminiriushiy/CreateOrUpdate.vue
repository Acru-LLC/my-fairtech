...
<script>
import CreateFormProductOrServices from "@/shared/views/components/CreateFormProductOrServicesDaminiriushiy";
...
export default {
    ...
    * COMPUTED */
    computed: {
        isModeCreate () {
            return this.$route.name === 'CreateProductOrServiceDaminiriushiy'
        },
        computedObserver () {
