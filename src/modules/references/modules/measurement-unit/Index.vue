  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.measurament_unit.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
...
export default {
  page: {
    title:  i18n.t('submodules.measurement_unit.title'),
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateMeasurementUnit', params: {id: id}})
    },
    deleteItem(id) {
