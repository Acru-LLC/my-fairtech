  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.work_days.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
            ...
            <template #cell(name)="data">
              <div class="d-flex justify-content-between">
                ...
                <p
                    class="mb-0 d-flex align-items-center"
                    style="flex-basis: 0; flex-grow: 1; gap: .3rem;"
                ><span class="badge bg-primary">EN</span> : <span> {{ data.item.nameEn }}</span></p>
              </div>
            </template>
...
<script>
const REF_NAME = '/directory/work-days'
...
export default {
  ...
  data() {
    return {
      ...
      title: this.$t('submodules.work_days.title'),
      activeDep: {},
      tableItems: [],
      totalItems: 0,
      tableFields: [
  ...
  methods: {
    downloadExcel() {
      ...
      if (!(this?.tableItems instanceof Array)) {
        return false;
      }
    ...
    async fetchTableItems() {
      ...
      if (this.$i18n.locale == 'uz') {
        ...
        this.var_default_search_payload.sortBy.push('nameEn')
      }
      // GET STATUSES
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateWorkDays', params: {id: id}})
    },
  },
  /* CREATED */
  created() {
