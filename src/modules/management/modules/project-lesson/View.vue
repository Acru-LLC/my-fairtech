...
export default {
  ...
  computed: {
    ...
    labels() {
      return {
        nameLt: this.$t('open_data.compliance_list.subjectName', 'uz') + ' (o\'z)',
        nameUz: this.$t('open_data.compliance_list.subjectName', 'uzCyrillic') + ' (ўз)',
        nameRu: this.$t('open_data.compliance_list.subjectName', 'ru') + ' (ру)',
        nameEn: this.$t('open_data.compliance_list.subjectName', 'en') + ' (en)',
      }
    }
  },
  methods: {
