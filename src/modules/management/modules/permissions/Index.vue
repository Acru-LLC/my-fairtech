  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.permissions.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
...
export default {
  ...
  data() {
    return {
      ...
      tableFields: [
        ...
        {label: this.$t('column.type'), key: "typeName"},
        {
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdatePermissions', params: {id: id}})
    },
    deleteItem(id) {
