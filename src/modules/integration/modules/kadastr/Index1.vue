  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.integration.kadastr_soliq_info.fullTitle') }}</div>
      </div>
      <div class="mb-4">
        <b-card-group deck>
          <b-card @click="$router.push({name: 'IntegrationKadastrInfo1Index'})" style="cursor: pointer; height: 50px"
                  bg-variant="primary" text-variant="white" no-header class="text-center">
              <b-card-text class="mb-5">{{ $t('submodules.integration.kadastr_soliq_info.method_1') }}</b-card-text>
          </b-card>

          <b-card @click="$router.push({name: 'IntegrationKadastrInfo2Index'})" style="cursor: pointer ; height: 50px"
                  bg-variant="warning" text-variant="white" class="text-center">
            <b-card-text>{{ $t('submodules.integration.kadastr_soliq_info.method_2') }}</b-card-text>
          </b-card>

          <b-card @click="$router.push({name: 'IntegrationKadastrInfo3Index'})" style="cursor: pointer; height: 50px"
                  bg-variant="success" text-variant="white" class="text-center">
            <b-card-text>{{ $t('submodules.integration.kadastr_soliq_info.method_3') }}</b-card-text>
          </b-card>
        </b-card-group>
      </div>
      <div class="card">
...
import Info from './methods/methods1'
