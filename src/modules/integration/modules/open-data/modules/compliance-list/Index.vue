            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.compliance_list.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.compliance_list.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataComplianceList'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.compliance_list.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.compliance_list.subjectName')]: this.getName({
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.compliance_list.subjectName'), key: this.getName({
            nameUz: 'subjectNameUz',
            nameRu: 'subjectNameRu',
            nameLt: 'subjectNameLt',
          }),
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.compliance_list.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataComplianceList', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataComplianceList', params: {id: id}})
    },
    deleteItem(id) {
