    ...
    <b-col cols="12">
      <b-col md="12" class="text-center">
        <div class="h4 mb-4 d-inline-block">
          {{ $t('open_data.regions_product_price.code') }} - {{ $t('open_data.regions_product_price.title') }}
        </div>
      </b-col>
      <b-card>
        <b-card-body>
            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.regions_product_price.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.regions_product_price.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataRegionsProductPrice'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.regions_product_price.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.regions_product_price.product_name')]: this.getName({
          nameUz: 'productNameUz',
          nameRu: 'productNameRu',
          nameLt: 'productNameLt',
        }),
        [this.$t('open_data.regions_product_price.unit')]: this.getName({
          nameUz: 'unitUz',
          nameRu: 'unitRu',
          nameLt: 'unitLt',
        }),
        [this.$t('open_data.regions_product_price.average')]: 'average',
        [this.$t('open_data.regions_product_price.tashkent_city')]: 'tashkentCity',
        [this.$t('open_data.regions_product_price.karakalpakstan')]: 'karakalpakstan',
        [this.$t('open_data.regions_product_price.andijan')]: 'andijan',
        [this.$t('open_data.regions_product_price.bukhara')]: 'bukhara',
        [this.$t('open_data.regions_product_price.jizzakh')]: 'jizzakh',
        [this.$t('open_data.regions_product_price.kashkadarya')]: 'kashkadarya',
        [this.$t('open_data.regions_product_price.navoi')]: 'navoi',
        [this.$t('open_data.regions_product_price.namangan')]: 'namangan',
        [this.$t('open_data.regions_product_price.samarkand')]: 'samarkand',
        [this.$t('open_data.regions_product_price.surkhandarya')]: 'surkhandarya',
        [this.$t('open_data.regions_product_price.syrdarya')]: 'syrdarya',
        [this.$t('open_data.regions_product_price.tashkent')]: 'tashkent',
        [this.$t('open_data.regions_product_price.fergana')]: 'fergana',
        [this.$t('open_data.regions_product_price.khorazm')]: 'khorazm'
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.regions_product_price.product_name'), key: this.getName({
            nameUz: 'productNameUz',
            nameRu: 'productNameRu',
            nameLt: 'productNameLt',
          }),
        ...
        {
          label: this.$t('open_data.regions_product_price.unit'), key: this.getName({
            nameUz: 'unitUz',
            nameRu: 'unitRu',
            nameLt: 'unitLt',
          }),
        },
        {label: this.$t('open_data.regions_product_price.average'), key: 'average'},
        {label: this.$t('open_data.regions_product_price.tashkent_city'), key: 'tashkentCity'},
        {label: this.$t('open_data.regions_product_price.karakalpakstan'), key: 'karakalpakstan'},
        {label: this.$t('open_data.regions_product_price.andijan'), key: 'andijan'},
        {label: this.$t('open_data.regions_product_price.bukhara'), key: 'bukhara'},
        {label: this.$t('open_data.regions_product_price.jizzakh'), key: 'jizzakh'},
        {label: this.$t('open_data.regions_product_price.kashkadarya'), key: 'kashkadarya'},
        {label: this.$t('open_data.regions_product_price.navoi'), key: 'navoi'},
        {label: this.$t('open_data.regions_product_price.namangan'), key: 'namangan'},
        {label: this.$t('open_data.regions_product_price.samarkand'), key: 'samarkand'},
        {label: this.$t('open_data.regions_product_price.surkhandarya'), key: 'surkhandarya'},
        {label: this.$t('open_data.regions_product_price.syrdarya'), key: 'syrdarya'},
        {label: this.$t('open_data.regions_product_price.tashkent'), key: 'tashkent'},
        {label: this.$t('open_data.regions_product_price.fergana'), key: 'fergana'},
        {label: this.$t('open_data.regions_product_price.khorazm'), key: 'khorazm'},
        {
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.regions_product_price.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    fetchTableItems() {
      ...
      if (this.$i18n.locale === 'uz') {
        this.var_default_search_payload.sortBy.push('productNameLt')
      } else if (this.$i18n.locale === 'ru') {
        this.var_default_search_payload.sortBy.push('productNameRu')
      } else if (this.$i18n.locale === 'uzCyrillic') {
        this.var_default_search_payload.sortBy.push('productNameUz')
      }
      crudAndListsService
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataRegionsProductPrice', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataRegionsProductPrice', params: {id: id}})
    },
    deleteItem(id) {
