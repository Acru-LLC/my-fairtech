    ...
    <b-col cols="12">
      <b-col md="12" class="text-center">
        <div class="h4 mb-4 d-inline-block">
          {{ $t('open_data.advertising_law_violation.code') }} - {{ $t('open_data.advertising_law_violation.title') }}
        </div>
      </b-col>
      <b-card>
        <b-card-body>
            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.advertising_law_violation.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.advertising_law_violation.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataAdvertisingLawViolation'}"
              >
          ...
          >
            ...
            <template #cell(change_index)="data">
              <div class="d-flex justify-content-center">
                ...
                >
                  <i class="mdi"
                     :class="changeIndex.firstItemId === data.item.id || changeIndex.secondItemId === data.item.id ?
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.advertising_law_violation.code')}.xlsx`"
                   class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
<script>
const MAIN_API_URL = 'open-data/advertising-law-violation'
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.advertising_law_violation.areaName')]: this.getName({
          nameUz: 'areaNameUz',
          nameRu: 'areaNameRu',
          nameLt: 'areaNameLt',
        }),
        [this.$t('open_data.advertising_law_violation.basedOMJtK')]: 'basedOMJtK',
        [this.$t('open_data.advertising_law_violation.deficiency')]: 'deficiency',
        [this.$t('open_data.advertising_law_violation.fineAmount')]: 'fineAmount',
        [this.$t('open_data.advertising_law_violation.fineDecisions')]: 'fineDecisions',
        [this.$t('open_data.advertising_law_violation.fineDenied')]: 'fineDenied',
        [this.$t('open_data.advertising_law_violation.learningMonitoring')]: 'learningMonitoring',
        [this.$t('open_data.advertising_law_violation.placedAds')]: 'placedAds',
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.advertising_law_violation.areaName'), key: this.getName({
            nameUz: 'areaNameUz',
            nameRu: 'areaNameRu',
            nameLt: 'areaNameLt',
          }),
        },
        {label: this.$t('open_data.advertising_law_violation.placedAds'), key: 'placedAds',},
        {label: this.$t('open_data.advertising_law_violation.learningMonitoring'), key: 'learningMonitoring',},
        // {label: this.$t('open_data.advertising_law_violation.deficiency'), key: 'deficiency',},
        // {label: this.$t('open_data.advertising_law_violation.basedOMJtK'), key: 'basedOMJtK',},
        {label: this.$t('open_data.advertising_law_violation.fineDecisions'), key: 'fineDecisions',},
        {label: this.$t('open_data.advertising_law_violation.fineAmount'), key: 'fineAmount',},
        {label: this.$t('open_data.advertising_law_violation.fineDenied'), key: 'fineDenied',},
        {
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.advertising_law_violation.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    fetchTableItems() {
      ...
      if (this.$i18n.locale === 'uz') {
        this.var_default_search_payload.sortBy.push('areaNameLt')
      } else if (this.$i18n.locale === 'ru') {
        this.var_default_search_payload.sortBy.push('areaNameRu')
      } else if (this.$i18n.locale === 'uzCyrillic') {
        this.var_default_search_payload.sortBy.push('areaNameUz')
      }
      crudAndListsService
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataAdvertisingLawViolation', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataAdvertisingLawViolation', params: {id: id}})
    },
    deleteItem(id) {
