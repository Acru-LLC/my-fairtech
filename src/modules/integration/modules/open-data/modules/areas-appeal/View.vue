...
export default {
  ...
  data() {
    return {
      title: this.$t('open_data.areas_appeal.title'),
      editingItem: {},
      statuses: []
    }
  },
  computed: {
    ...
    labels() {
      return {
        home: this.$t('open_data.areas_appeal.home'),
        sale: this.$t('open_data.areas_appeal.sale'),
        communication: this.$t('open_data.areas_appeal.communication'),
        advertising: this.$t('open_data.areas_appeal.advertising'),
      }
    }
  },
  methods: {
