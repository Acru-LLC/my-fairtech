...
export default {
  ...
  data() {
    return {
      title: this.$t('open_data.analysis_result.title'),
      editingItem: {},
      statuses: []
    }
  },
  computed: {
    ...
    labels() {
      return {
        nameLt: this.$t('open_data.analysis_result.name', 'uz') + ' (o\'z)',
        nameUz: this.$t('open_data.analysis_result.name', 'uzCyrillic') + ' (ўз)',
        nameRu: this.$t('open_data.analysis_result.name', 'ru') + ' (ру)',
        workNameLt: this.$t('open_data.analysis_result.workName', 'uz') + ' (o\'z)',
        workNameUz: this.$t('open_data.analysis_result.workName', 'uzCyrillic') + ' (ўз)',
        workNameRu: this.$t('open_data.analysis_result.workName', 'ru') + ' (ру)',
      }
    }
  },
  methods: {
