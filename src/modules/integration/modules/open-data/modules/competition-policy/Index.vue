            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.competition_policy.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.competition_policy.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataCompetitionPolicy'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.competition_policy.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.competition_policy.indicatorName')]: this.getName({
          nameUz: 'indicatorNameUz',
          nameRu: 'indicatorNameRu',
          nameLt: 'indicatorNameLt',
        }),
        [this.$t('open_data.competition_policy.indicator')]: 'indicator',
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.competition_policy.indicatorName'), key: this.getName({
            nameUz: 'indicatorNameUz',
            nameRu: 'indicatorNameRu',
            nameLt: 'indicatorNameLt',
          }),
        ...
        {
          label: this.$t('open_data.competition_policy.indicator'), key: 'indicator',
        },
        {
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.competition_policy.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    fetchTableItems() {
      ...
      if (this.$i18n.locale === 'uz') {
        this.var_default_search_payload.sortBy.push('indicatorNameLt')
      } else if (this.$i18n.locale === 'ru') {
        this.var_default_search_payload.sortBy.push('indicatorNameRu')
      } else if (this.$i18n.locale === 'uzCyrillic') {
        this.var_default_search_payload.sortBy.push('indicatorNameUz')
      }
      crudAndListsService
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataCompetitionPolicy', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataCompetitionPolicy', params: {id: id}})
    },
    deleteItem(id) {
