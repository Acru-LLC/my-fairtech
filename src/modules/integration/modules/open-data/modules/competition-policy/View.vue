...
export default {
  ...
  data() {
    return {
      title: this.$t('open_data.competition_policy.title'),
      editingItem: {},
      statuses: []
    }
  },
  computed: {
    ...
    labels() {
      return {
        indicatorNameLt: this.$t('open_data.competition_policy.indicatorName', 'uz') + ' (o\'z)',
        indicatorNameUz: this.$t('open_data.competition_policy.indicatorName', 'uzCyrillic') + ' (ўз)',
        indicatorNameRu: this.$t('open_data.competition_policy.indicatorName', 'ru') + ' (ру)',
        indicator: this.$t('open_data.competition_policy.indicator'),
      }
    }
  },
  methods: {
