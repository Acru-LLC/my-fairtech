    ...
    <b-col cols="12">
      <b-col md="12" class="text-center">
        <div class="h4 mb-4 d-inline-block">
          {{ $t('open_data.property_information.code') }} - {{ $t('open_data.property_information.title') }}
        </div>
      </b-col>
      <b-card>
        <b-card-body>
            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.property_information.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.property_information.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataPropertyInformation'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.property_information.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
<script>
const MAIN_API_URL = 'open-data/property-information'
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.property_information.organizationName', 'uz')]: 'organizationNameLt',
        [this.$t('open_data.property_information.organizationName', 'uzCyrillic')]: 'organizationNameUz',
        [this.$t('open_data.property_information.organizationName', 'ru')]: 'organizationNameRu',
        [this.$t('open_data.property_information.organizationName', 'en')]: 'organizationNameEn',
        [this.$t('open_data.property_information.totalTransport')]: 'totalTransport',
        [this.$t('open_data.property_information.attachedTransport')]: 'attachedTransport',
        [this.$t('open_data.property_information.duty')]: 'duty',
        [this.$t('open_data.property_information.model')]: 'model',
        [this.$t('open_data.property_information.year')]: 'year',
        [this.$t('open_data.property_information.totalBuilding')]: 'totalBuilding',
        [this.$t('open_data.property_information.used')]: 'used',
        [this.$t('open_data.property_information.notUsed')]: 'notUsed',
        [this.$t('open_data.property_information.serviceHouse')]: 'serviceHouse',
        [this.$t('open_data.property_information.other')]: 'other',
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.property_information.organizationName'), key: this.getName({
            nameUz: 'organizationNameUz',
            nameRu: 'organizationNameRu',
            nameLt: 'organizationNameLt',
          }),
        },
        {label: this.$t('open_data.property_information.totalTransport'), key: 'totalTransport'},
        {label: this.$t('open_data.property_information.attachedTransport'), key: 'attachedTransport'},
        {label: this.$t('open_data.property_information.duty'), key: 'duty'},
        {label: this.$t('open_data.property_information.model'), key: 'model'},
        {label: this.$t('open_data.property_information.year'), key: 'year'},
        {label: this.$t('open_data.property_information.totalBuilding'), key: 'totalBuilding'},
        {label: this.$t('open_data.property_information.used'), key: 'used'},
        {label: this.$t('open_data.property_information.notUsed'), key: 'notUsed'},
        {label: this.$t('open_data.property_information.serviceHouse'), key: 'serviceHouse'},
        {label: this.$t('open_data.property_information.other'), key: 'other'},
        {
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.property_information.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    fetchTableItems() {
      ...
      if (this.$i18n.locale === 'uz') {
        this.var_default_search_payload.sortBy.push('organizationNameLt')
      } else if (this.$i18n.locale === 'ru') {
        this.var_default_search_payload.sortBy.push('organizationNameRu')
      } else if (this.$i18n.locale === 'uzCyrillic') {
        this.var_default_search_payload.sortBy.push('organizationNameUz')
      }
      crudAndListsService
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataPropertyInformation', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataPropertyInformation', params: {id: id}})
    },
    deleteItem(id) {
