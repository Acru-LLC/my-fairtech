...
export default {
  ...
  data() {
    return {
      title: this.$t('open_data.stock_competition_law.title'),
      editingItem: {},
      statuses: []
    }
  },
  computed: {
    ...
    labels() {
      return {
        acrossRegion: this.$t('open_data.stock_competition_law.across_region'),
        acrossRegionDeficiency: this.$t('open_data.stock_competition_law.across_region_deficiency'),
        learnPurchase: this.$t('open_data.stock_competition_law.learn_purchase'),
        learnPurchaseDeficiency: this.$t('open_data.stock_competition_law.learn_purchase_deficiency'),
      }
    }
  },
  methods: {
