    ...
    <b-col cols="12">
      <b-col md="12" class="text-center">
        <div class="h4 mb-4 d-inline-block">
          {{ $t('open_data.stock_competition_law.code') }} - {{ $t('open_data.stock_competition_law.title') }}
        </div>
      </b-col>
      <b-card>
        <b-card-body>
            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.stock_competition_law.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.stock_competition_law.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataStockCompetitionLaw'}"
              >
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              <a :href="`/template/opendata/${$t('open_data.stock_competition_law.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
            </div>
          </div>
          <div class="col-md-12">
...
<script>
const MAIN_API_URL = 'open-data/stock-competition-law'
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.stock_competition_law.across_region')]: 'acrossRegion',
        [this.$t('open_data.stock_competition_law.across_region_deficiency')]: 'acrossRegionDeficiency',
        [this.$t('open_data.stock_competition_law.learn_purchase')]: 'acrossRegionDeficiency',
        [this.$t('open_data.stock_competition_law.learn_purchase_deficiency')]: 'learnPurchaseDeficiency'
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {label: this.$t('open_data.stock_competition_law.across_region'), key: 'acrossRegion'},
        {label: this.$t('open_data.stock_competition_law.across_region_deficiency'), key: 'acrossRegionDeficiency'},
        {label: this.$t('open_data.stock_competition_law.learn_purchase'), key: 'learnPurchase'},
        {label: this.$t('open_data.stock_competition_law.learn_purchase_deficiency'), key: 'learnPurchaseDeficiency'},
        {
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.stock_competition_law.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    fetchTableItems() {
      ...
      if (this.$i18n.locale === 'uz') {
        this.var_default_search_payload.sortBy.push('acrossRegion')
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataStockCompetitionLaw', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataStockCompetitionLaw', params: {id: id}})
    },
    deleteItem(id) {
