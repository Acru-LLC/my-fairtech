            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.product_price_quotation.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.product_price_quotation.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataProductPriceQuotation'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.product_price_quotation.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.product_price_quotation.productName')]: 'productName',
        [this.$t('open_data.product_price_quotation.quotation')]: 'quotation',
        [this.$t('open_data.product_price_quotation.dynamics')]: 'dynamics',
        [this.$t('open_data.product_price_quotation.sum')]: 'sum',
        [this.$t('open_data.product_price_quotation.percent')]: 'percent',
        [this.$t('open_data.product_price_quotation.day')]: 'day',
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {label: this.$t('open_data.product_price_quotation.productName'), key: 'productName'},
        {label: this.$t('open_data.product_price_quotation.quotation'), key: 'quotation'},
        {label: this.$t('open_data.product_price_quotation.dynamics'), key: 'dynamics'},
        {label: this.$t('open_data.product_price_quotation.sum'), key: 'sum'},
        {label: this.$t('open_data.product_price_quotation.percent'), key: 'percent'},
        {label: this.$t('open_data.product_price_quotation.day'), key: 'day'},
        {
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.product_price_quotation.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    fetchTableItems() {
      ...
      this.var_default_search_payload.sortBy.push('productName')
      crudAndListsService
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataProductPriceQuotation', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataProductPriceQuotation', params: {id: id}})
    },
    deleteItem(id) {
