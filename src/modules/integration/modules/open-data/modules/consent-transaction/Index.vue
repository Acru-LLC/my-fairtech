            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.consent_transaction.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.consent_transaction.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataConsentTransaction'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.consent_transaction.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.consent_transaction.committeeName')]: this.getName({
          nameUz: 'committeeNameUz',
          nameRu: 'committeeNameRu',
          nameLt: 'committeeNameLt',
        }),
        [this.$t('open_data.consent_transaction.add')]: 'add',
        [this.$t('open_data.consent_transaction.specialOne')]: 'specialOne',
        [this.$t('open_data.consent_transaction.notRequiredOne')]: 'notRequiredOne',
        [this.$t('open_data.consent_transaction.rejectedOne')]: 'rejectedOne',
        [this.$t('open_data.consent_transaction.share')]: 'share',
        [this.$t('open_data.consent_transaction.specialTwo')]: 'specialTwo',
        [this.$t('open_data.consent_transaction.notRequiredTwo')]: 'notRequiredTwo',
        [this.$t('open_data.consent_transaction.rejectedTwo')]: 'rejectedTwo',
        [this.$t('open_data.consent_transaction.total')]: 'total',
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.consent_transaction.committeeName'), key: this.getName({
            nameUz: 'committeeNameUz',
            nameRu: 'committeeNameRu',
            nameLt: 'committeeNameLt',
          }),
        },
        {label: this.$t('open_data.consent_transaction.add'), key: 'add'},
        {label: this.$t('open_data.consent_transaction.specialOne'), key: 'specialOne'},
        {label: this.$t('open_data.consent_transaction.notRequiredOne'), key: 'notRequiredOne'},
        {label: this.$t('open_data.consent_transaction.rejectedOne'), key: 'rejectedOne'},
        {label: this.$t('open_data.consent_transaction.share'), key: 'share'},
        {label: this.$t('open_data.consent_transaction.specialTwo'), key: 'specialTwo'},
        {label: this.$t('open_data.consent_transaction.notRequiredTwo'), key: 'notRequiredTwo'},
        {label: this.$t('open_data.consent_transaction.rejectedTwo'), key: 'rejectedTwo'},
        {label: this.$t('open_data.consent_transaction.total'), key: 'total'},
        {
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.consent_transaction.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    fetchTableItems() {
      ...
      if (this.$i18n.locale === 'uz') {
        this.var_default_search_payload.sortBy.push('committeeNameLt')
      } else if (this.$i18n.locale === 'ru') {
        this.var_default_search_payload.sortBy.push('committeeNameRu')
      } else if (this.$i18n.locale === 'uzCyrillic') {
        this.var_default_search_payload.sortBy.push('committeeNameUz')
      }
      crudAndListsService
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataConsentTransaction', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataConsentTransaction', params: {id: id}})
    },
    deleteItem(id) {
