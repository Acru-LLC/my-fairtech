...
export default {
  ...
  data() {
    return {
      title: this.$t('open_data.stock_product.title'),
      editingItem: {},
      statuses: []
    }
  },
  computed: {
    ...
    labels() {
      return {
        productNameLt: this.$t('open_data.stock_product.product_name', 'uz') + ' (o\'z)',
        productNameUz: this.$t('open_data.stock_product.product_name', 'uzCyrillic') + ' (ўз)',
        productNameRu: this.$t('open_data.stock_product.product_name', 'ru') + ' (ру)',
        productNameEn: this.$t('open_data.stock_product.product_name', 'en') + ' (en)',
      }
    }
  },
  methods: {
