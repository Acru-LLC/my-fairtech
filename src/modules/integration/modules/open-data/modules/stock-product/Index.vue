            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.stock_product.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.stock_product.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataStockProduct'}"
              >
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              <a :href="`/template/opendata/${$t('open_data.stock_product.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
            </div>
          </div>
          <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.stock_product.product_name')]: this.getName({
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.stock_product.product_name'), key: this.getName({
            nameUz: 'productNameUz',
            nameRu: 'productNameRu',
            nameLt: 'productNameLt',
          }),
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.stock_product.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataStockProduct', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataStockProduct', params: {id: id}})
    },
    deleteItem(id) {
