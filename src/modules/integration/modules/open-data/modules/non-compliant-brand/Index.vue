    ...
    <b-col cols="12">
      <b-col md="12" class="text-center">
        <div class="h4 mb-4 d-inline-block">
          {{ $t('open_data.non_compliant_brand.code') }} - {{ $t('open_data.non_compliant_brand.title') }}
        </div>
      </b-col>
      <b-card>
        <b-card-body>
            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.non_compliant_brand.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.non_compliant_brand.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataNonCompliantBrand'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.non_compliant_brand.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.non_compliant_brand.productName', 'uz')]: 'productNameLt',
        [this.$t('open_data.non_compliant_brand.productName', 'uzCyrillic')]: 'productNameUz',
        [this.$t('open_data.non_compliant_brand.productName', 'ru')]: 'productNameRu',
        [this.$t('open_data.non_compliant_brand.productName', 'en')]: 'productNameEn',
        [this.$t('open_data.non_compliant_brand.tradeName', 'uz')]: 'tradeNameLt',
        [this.$t('open_data.non_compliant_brand.tradeName', 'uzCyrillic')]: 'tradeNameUz',
        [this.$t('open_data.non_compliant_brand.tradeName', 'ru')]: 'tradeNameRu',
        [this.$t('open_data.non_compliant_brand.tradeName', 'en')]: 'tradeNameEn',
        [this.$t('open_data.non_compliant_brand.manufacturer', 'uz')]: 'manufacturerLt',
        [this.$t('open_data.non_compliant_brand.manufacturer', 'uzCyrillic')]: 'manufacturerUz',
        [this.$t('open_data.non_compliant_brand.manufacturer', 'ru')]: 'manufacturerRu',
        [this.$t('open_data.non_compliant_brand.manufacturer', 'en')]: 'manufacturerEn',
        [this.$t('open_data.non_compliant_brand.controlPurchaseDate')]: 'controlPurchaseDate',
        [this.$t('open_data.non_compliant_brand.startDate')]: 'startDate',
        [this.$t('open_data.non_compliant_brand.endDate')]: 'endDate',
        [this.$t('open_data.non_compliant_brand.testResult', 'uz')]: 'testResultLt',
        [this.$t('open_data.non_compliant_brand.testResult', 'uzCyrillic')]: 'testResultUz',
        [this.$t('open_data.non_compliant_brand.testResult', 'ru')]: 'testResultRu',
        [this.$t('open_data.non_compliant_brand.testResult', 'en')]: 'testResultEn',
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.non_compliant_brand.productName'), key: this.getName({
        ...
        {
          label: this.$t('open_data.non_compliant_brand.tradeName'), key: this.getName({
            nameUz: 'tradeNameUz',
            nameRu: 'tradeNameRu',
            nameLt: 'tradeNameLt',
          }),
        ...
        {
          label: this.$t('open_data.non_compliant_brand.manufacturer'), key: this.getName({
            nameUz: 'manufacturerUz',
            nameRu: 'manufacturerRu',
            nameLt: 'manufacturerLt',
          }),
        },
        {label: this.$t('open_data.non_compliant_brand.controlPurchaseDate'), key: 'controlPurchaseDate'},
        {label: this.$t('open_data.non_compliant_brand.startDate'), key: 'startDate'},
        {label: this.$t('open_data.non_compliant_brand.endDate'), key: 'endDate'},
        {
          label: this.$t('open_data.non_compliant_brand.testResult'), key: this.getName({
            nameUz: 'testResultUz',
            nameRu: 'testResultRu',
            nameLt: 'testResultLt',
          }),
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.non_compliant_brand.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataNonCompliantBrand', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataNonCompliantBrand', params: {id: id}})
    },
    deleteItem(id) {
