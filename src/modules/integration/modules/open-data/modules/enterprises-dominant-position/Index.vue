            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.enterprises_dominant_position.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.enterprises_dominant_position.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataEnterprisesDominantPosition'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.enterprises_dominant_position.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.enterprises_dominant_position.subjectName')]: this.getName({
          nameUz: 'subjectNameUz',
          nameRu: 'subjectNameRu',
          nameLt: 'subjectNameLt',
        }),
        [this.$t('open_data.enterprises_dominant_position.monopolyGoodsName')]: this.getName({
          nameUz: 'monopolyGoodsNameUz',
          nameRu: 'monopolyGoodsNameRu',
          nameLt: 'monopolyGoodsNameLt',
        }),
      },
      json_data: [],
      json_meta: [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.enterprises_dominant_position.subjectName'), key: this.getName({
            nameUz: 'subjectNameUz',
            nameRu: 'subjectNameRu',
            nameLt: 'subjectNameLt',
          }),
        ...
        {
          label: this.$t('open_data.enterprises_dominant_position.monopolyGoodsName'), key: this.getName({
            nameUz: 'monopolyGoodsNameUz',
            nameRu: 'monopolyGoodsNameRu',
            nameLt: 'monopolyGoodsNameLt',
          }),
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.enterprises_dominant_position.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataEnterprisesDominantPosition', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataEnterprisesDominantPosition', params: {id: id}})
    },
    deleteItem(id) {
