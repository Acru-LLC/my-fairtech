    ...
    <b-col cols="12">
      <b-col md="12" class="text-center">
        <div class="h4 mb-4 d-inline-block">
          {{ $t('open_data.entities_violate_competition.code') }} - {{ $t('open_data.entities_violate_competition.title') }}
        </div>
      </b-col>
      <b-card>
        <b-card-body>
            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.entities_violate_competition.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.entities_violate_competition.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataEntitiesViolateCompetition'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.entities_violate_competition.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.entities_violate_competition.subjectName')]: this.getName({
          nameUz: 'subjectNameUz',
          nameRu: 'subjectNameRu',
          nameLt: 'subjectNameLt',
        }),
        [this.$t('open_data.entities_violate_competition.documentName')]: this.getName({
          nameUz: 'documentNameUz',
          nameRu: 'documentNameRu',
          nameLt: 'documentNameLt',
        }),
        [this.$t('open_data.entities_violate_competition.contentOfOffense')]: this.getName({
          nameUz: 'contentOfOffenseUz',
          nameRu: 'contentOfOffenseRu',
          nameLt: 'contentOfOffenseLt',
        }),
        [this.$t('open_data.entities_violate_competition.contentOfAction')]: this.getName({
          nameUz: 'contentOfActionUz',
          nameRu: 'contentOfActionRu',
          nameLt: 'contentOfActionLt',
        }),
      },
      json_data: [],
      json_meta: [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.entities_violate_competition.subjectName'), key: this.getName({
            nameUz: 'subjectNameUz',
            nameRu: 'subjectNameRu',
            nameLt: 'subjectNameLt',
          }),
        ...
        {
          label: this.$t('open_data.entities_violate_competition.documentName'), key: this.getName({
            nameUz: 'documentNameUz',
            nameRu: 'documentNameRu',
            nameLt: 'documentNameLt',
          }),
        ...
        {
          label: this.$t('open_data.entities_violate_competition.contentOfOffense'), key: this.getName({
            nameUz: 'contentOfOffenseUz',
            nameRu: 'contentOfOffenseRu',
            nameLt: 'contentOfOffenseLt',
          }),
        ...
        {
          label: this.$t('open_data.entities_violate_competition.contentOfAction'), key: this.getName({
            nameUz: 'contentOfActionUz',
            nameRu: 'contentOfActionRu',
            nameLt: 'contentOfActionLt',
          }),
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.entities_violate_competition.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataEntitiesViolateCompetition', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataEntitiesViolateCompetition', params: {id: id}})
    },
    deleteItem(id) {
