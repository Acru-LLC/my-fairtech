            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.subordinate_organization.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.subordinate_organization.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataSubordinateOrganization'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.subordinate_organization.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.subordinate_organization.organization_name')]: this.getName({
          nameUz: 'organizationNameUz',
          nameRu: 'organizationNameRu',
          nameLt: 'organizationNameLt',
        }),
        [this.$t('open_data.subordinate_organization.address')]: this.getName({
          nameUz: 'addressNameUz',
          nameRu: 'addressNameRu',
          nameLt: 'addressNameLt',
        }),
        [this.$t('open_data.subordinate_organization.latitude')]: 'latitude',
        [this.$t('open_data.subordinate_organization.longitude')]: 'longitude',
        [this.$t('open_data.subordinate_organization.address_location')]: 'addressLocation',
        [this.$t('open_data.subordinate_organization.email')]: 'email',
        [this.$t('open_data.subordinate_organization.phone')]: 'phone'
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.subordinate_organization.organization_name'), key: this.getName({
            nameUz: 'organizationNameUz',
            nameRu: 'organizationNameRu',
            nameLt: 'organizationNameLt',
          }),
        ...
        {
          label: this.$t('open_data.subordinate_organization.address'), key: this.getName({
            nameUz: 'addressUz',
            nameRu: 'addressRu',
            nameLt: 'addressLt',
          }),
        },
        {label: this.$t('open_data.subordinate_organization.latitude'), key: 'latitude'},
        {label: this.$t('open_data.subordinate_organization.longitude'), key: 'longitude'},
        {label: this.$t('open_data.subordinate_organization.address_location'), key: 'addressLocation'},
        {label: this.$t('open_data.subordinate_organization.email'), key: 'email'},
        {label: this.$t('open_data.subordinate_organization.phone'), key: 'phone'},
        {
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.subordinate_organization.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataSubordinateOrganization', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataSubordinateOrganization', params: {id: id}})
    },
    deleteItem(id) {
