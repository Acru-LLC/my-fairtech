    ...
    <b-col cols="12">
      <b-col md="12" class="text-center">
        <div class="h4 mb-4 d-inline-block">
          {{ $t('open_data.service_cost.code') }} - {{ $t('open_data.service_cost.title') }}
        </div>
      </b-col>
      <b-card>
        <b-card-body>
            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.service_cost.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.service_cost.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataServiceCost'}"
              >
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="form-group">
              <a :href="`/template/opendata/${$t('open_data.service_cost.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
            </div>
          </div>
          <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.service_cost.name')]: this.getName({
          nameUz: 'nameUz',
          nameRu: 'nameRu',
          nameLt: 'nameLt',
        }),
        [this.$t('open_data.service_cost.position_name')]: this.getName({
          nameUz: 'positionNameUz',
          nameRu: 'positionNameRu',
          nameLt: 'positionNameLt',
        }),
        [this.$t('open_data.service_cost.certificate_number')]: 'certificateNumber',
        [this.$t('open_data.service_cost.order')]: 'order',
        [this.$t('open_data.service_cost.trip_purpose_name')]: this.getName({
          nameUz: 'tripPurposeNameUz',
          nameRu: 'tripPurposeNameRu',
          nameLt: 'tripPurposeNameLt',
        }),
        [this.$t('open_data.service_cost.trip_day')]: 'tripDay',
        [this.$t('open_data.service_cost.trip_address_name')]: this.getName({
          nameUz: 'tripAddressNameUz',
          nameRu: 'tripAddressNameRu',
          nameLt: 'tripAddressNameLt',
        }),
        [this.$t('open_data.service_cost.daily_cost')]: 'dailyCost',
        [this.$t('open_data.service_cost.dormitory_cost')]: 'dormitoryCost',
        [this.$t('open_data.service_cost.transport_cost')]: 'transportCost',
        [this.$t('open_data.service_cost.total')]: 'total'
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.service_cost.name'), key: this.getName({
            nameUz: 'nameUz',
            nameRu: 'nameRu',
            nameLt: 'nameLt',
          }),
        ...
        {
          label: this.$t('open_data.service_cost.position_name'), key: this.getName({
            nameUz: 'positionNameUz',
            nameRu: 'positionNameRu',
            nameLt: 'positionNameLt',
          }),
        },
        {label: this.$t('open_data.service_cost.certificate_number'), key: 'certificateNumber'},
        {label: this.$t('open_data.service_cost.order'), key: 'order'},
        {
          label: this.$t('open_data.service_cost.trip_purpose_name'), key: this.getName({
            nameUz: 'tripPurposeNameUz',
            nameRu: 'tripPurposeNameRu',
            nameLt: 'tripPurposeNameLt',
          }),
        },
        {label: this.$t('open_data.service_cost.trip_day'), key: 'tripDay'},
        {
          label: this.$t('open_data.service_cost.trip_address_name'), key: this.getName({
            nameUz: 'tripAddressNameUz',
            nameRu: 'tripAddressNameRu',
            nameLt: 'tripAddressNameLt',
          }),
        },
        {label: this.$t('open_data.service_cost.daily_cost'), key: 'dailyCost'},
        {label: this.$t('open_data.service_cost.dormitory_cost'), key: 'dormitoryCost'},
        {label: this.$t('open_data.service_cost.transport_cost'), key: 'transportCost'},
        {label: this.$t('open_data.service_cost.total'), key: 'total'},
        {
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.service_cost.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataServiceCost', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataServiceCost', params: {id: id}})
    },
    deleteItem(id) {
