            ...
            <div class="d-inline-block">
              ...
              <div class="text-sm-end float-right">
                <download-excel
                    :data="json_data"
                    :fields="json_fields"
                    :header="$t('open_data.consumer_right_reestr.title')"
                    worksheet="My Worksheet"
                    :name="`${$t('open_data.consumer_right_reestr.title')}.xls`"
                >
                  <b-btn
                      @click="downloadExcel"
                      type="button"
              ...
              <b-btn
                  ...
                  :to="{name: 'CreateOpenDataConsumerRightReestr'}"
              >
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="form-group">
                <a :href="`/template/opendata/${$t('open_data.consumer_right_reestr.code')}.xlsx`" class="btn btn-info" target="_blank" download>{{ $t('actions.download_template') }}</a>
              </div>
            </div>
            <div class="col-md-12">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        [this.$t('open_data.consumer_right_reestr.subjectName', 'uzCyrillic')]: 'subjectNameUz',
        [this.$t('open_data.consumer_right_reestr.subjectName', 'ru')]: 'subjectNameRu',
        [this.$t('open_data.consumer_right_reestr.subjectName', 'uz')]: 'subjectNameLt',
        [this.$t('open_data.consumer_right_reestr.subjectName', 'en')]: 'subjectNameEn',
        [this.$t('open_data.consumer_right_reestr.offenseStructure', 'uzCyrillic')]: 'offenseStructureUz',
        [this.$t('open_data.consumer_right_reestr.offenseStructure', 'ru')]: 'offenseStructureRu',
        [this.$t('open_data.consumer_right_reestr.offenseStructure', 'uz')]: 'offenseStructureLt',
        [this.$t('open_data.consumer_right_reestr.offenseStructure', 'en')]: 'offenseStructureEn',
        [this.$t('open_data.consumer_right_reestr.offenseContent', 'uzCyrillic')]: 'offenseContentUz',
        [this.$t('open_data.consumer_right_reestr.offenseContent', 'ru')]: 'offenseContentRu',
        [this.$t('open_data.consumer_right_reestr.offenseContent', 'uz')]: 'offenseContentLt',
        [this.$t('open_data.consumer_right_reestr.offenseContent', 'en')]: 'offenseContentEn',
        [this.$t('open_data.consumer_right_reestr.time')]: 'time',
      },
      json_data: [],
      json_meta: [
        [
      ...
      tableFields: [
        ...
        {
          label: this.$t('open_data.consumer_right_reestr.subjectName'), key: this.getName({
        ...
        {
          label: this.$t('open_data.consumer_right_reestr.offenseStructure'), key: this.getName({
            nameUz: 'offenseStructureUz',
            nameRu: 'offenseStructureRu',
            nameLt: 'offenseStructureLt',
          }),
        },
        {
          label: this.$t('open_data.consumer_right_reestr.offenseContent'), key: this.getName({
            nameUz: 'offenseContentUz',
            nameRu: 'offenseContentRu',
            nameLt: 'offenseContentLt',
          }),
        },
        {
          label: this.$t('open_data.consumer_right_reestr.time'), key: 'time',
        },
        {
  ...
  methods: {
    ...
    promptOpenDataToken(){
      this.promptSwal({
        ...
        if (isConfirmed) {
          openDataService.createToken(this.$t('open_data.consumer_right_reestr.code'), value)
        }
      })
    },
    fetchSendOpenData() {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOpenDataConsumerRightReestr', params: {id: id}})
    },
    viewItem(id) {
      this.$router.push({name: 'ViewOpenDataConsumerRightReestr', params: {id: id}})
    },
    deleteItem(id) {
