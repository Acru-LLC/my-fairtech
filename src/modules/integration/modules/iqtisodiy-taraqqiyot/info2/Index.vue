  ...
  <b-row>
    <b-col cols="12">
      ...
      <b-col md="12">
        <div class="mb-4">
          <b-card-group deck >
            <b-card  @click="$router.push({name: 'IntegrationIqtisodiyTaraqqiyotInfo1Index'})" style="cursor: pointer" bg-variant="primary" text-variant="white" no-header class="text-center">
              <b-card-text>{{ $t('submodules.integration.iqtisodiy_taraqqiyot_info.info1') }}</b-card-text>
            </b-card>

            <b-card @click="$router.push({name: 'IntegrationIqtisodiyTaraqqiyotInfo2Index'})" style="cursor: pointer" bg-variant="warning" text-variant="white" class="text-center">
              <b-card-text>{{ $t('submodules.integration.iqtisodiy_taraqqiyot_info.info2') }}</b-card-text>
            </b-card>

            <b-card @click="$router.push({name: 'IntegrationIqtisodiyTaraqqiyotInfo3Index'})" style="cursor: pointer" bg-variant="success" text-variant="white" class="text-center">
...
export default {
  ...
  data() {
    return {
      ...
      json_fields: {
        ...
        [this.$t('submodules.integration.iqtisodiy_taraqqiyot_info.fields.maxsulot_navi')]: 'Mahsulot_navi',
        [this.$t('submodules.integration.iqtisodiy_taraqqiyot_info.fields.olchov_birligi')]: 'Olchov_birligi',
        [this.$t('submodules.integration.iqtisodiy_taraqqiyot_info.fields.minimum')]: 'Minimal_',
        [this.$t('submodules.integration.iqtisodiy_taraqqiyot_info.fields.maximal')]: 'Maksimal_',
      },
      json_data: [],
      json_meta: [
        [
  ...
  methods: {
    ...
    fetchTableItems() {
      ...
      integratsiyaService.getIstisodiyotInformation2(this.period_date, true)
          .then(res => {
