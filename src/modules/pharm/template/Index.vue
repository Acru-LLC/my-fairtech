...
export default {
  ...
  data() {
    return {
      ...
      tableFields: [
        ...
        {
          label: this.$t('word_templates.template_header_name'),
          key: "image",
          thClass: "text-center",
          tdClass: "text-center"
        },
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdatePharmTemplate', params: {id: id}})
    },
