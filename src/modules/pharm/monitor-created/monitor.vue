...
<!--                                                         <a-->
                                                    ...
                                                    >
                                                        ...
                                                        <tr>
                                                            <td class="text-left">
                                                                <b> {{ $t('pharm.medicationCheckNumber') }}</b> <br>
                                                            </td>
                                                            <td class="text-right">
                                                    <span
                                                            style="font-size: 12px"
                                                            class="text-right"
                                                    >
                                                         {{ selectedAppealTrItem.medicationCheckNumber }}
                                                    </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    >
                                                         {{
                                                        selectedAppealTrItem.pharmacyRegionName ? selectedAppealTrItem.pharmacyRegionName : ''
                                                        }}
                                                         {{
                                                        selectedAppealTrItem.pharmacyDistrictName ? selectedAppealTrItem.pharmacyDistrictName : ''
                                                        }}
                                                         {{
                                                        selectedAppealTrItem.pharmacyAddress ? selectedAppealTrItem.pharmacyAddress : ''
                                                        }}
                                                    </span>
                                                            </td>
                                                        </tr>
