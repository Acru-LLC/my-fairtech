        ...
        <div class="wrapper">
            <div class="profile-card js-profile-card">
                <div class="profile-card__img">
                    <img src="../../../assets/pharm/logo.png"
                         alt="profile card">
                </div>

                <div class="profile-card__cnt js-profile-cnt">
                    <div class="profile-card__name"> O'zbekiston Respublikasi Raqobatni rivojlantirish va iste'molchilar
...
.wrapper {
  ...
  padding-top: 100px;
  display: flex;
  background-image: linear-gradient(-20deg, #c5c5c5 0%, #ffffff 100%);
