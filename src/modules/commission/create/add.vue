<template>
  <div style="min-height: 200px">
    ...
    <div v-else-if="form.docTypeId == null && active != null">
      ...
      <div class="row">
        ...
        >
          <div class="card my-card-hovered mr-2" s>
                  ...
                  <div class="mt-1 col-12">
                    <p style="font-size: 13px">
                      <strong>
                        {{
                          getName({
                            nameLt: dc.docTypeNameLt,
                            nameRu: dc.docTypeNameRu,
                          })
                        }}
                      </strong>
                    </p>
    ...
    <div v-else-if="active != null && form.docTypeId != null">
      <div class="d-flex justify-content-between mb-3">
        <h4 class="m-0">
          <strong>
            {{
              getName({
                nameLt: selectedObj.docTypeNameLt,
                nameRu: selectedObj.docTypeNameRu,
              })
            }}
          </strong>
        </h4>
        <b-button variant="light" @click="form.docTypeId = null">
          <i class="fa fa-times text-danger"></i>
        </b-button>
      </div>
...
import Service from "@/shared/services/docsService";
...
beforeCommissionProjectId: null
budget: null
description: "5"
end: "18-03-2022 00:00:00"
id: "7f6bc33c-f764-4bc5-9b96-d2a4d34c7fe8"
isAdmin: true
name: "\"AZIM-JAVLON FAYZ\" MAS'ULIYATI CHEKLANGAN JAMIYAT5"
projectType: "BEFORE_COMMISSION"
returnType: "FOR_PROCESS"
start: "17-03-2022 02:31:44"
status: "CREATED"
* */
    active: {
      handler(v) {
