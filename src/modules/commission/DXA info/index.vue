<template>
  <div class="card mb-0">
    <div class="pt-4 pl-5">
      ...
      <b-button v-show="statusFromDXA === 'VISA_APPROVED' && projectOwner" class="ml-3" @click="btn_click" variant="info">
        {{ $t('submodules.dxa.not_belong') }}
      </b-button>
      <b-button v-show="statusFromDXA === 'CREATED'" class="ml-3" @click="btn_return" variant="warning">
        {{ $t('column.return') }}
      </b-button>
    </div>
    <hr>
    ...
    >
      <div class="pt-5 pr-5 pl-5 pb-2">
        ...
        <b-button @click="$emit('createProject',applicationId)" class="mt-4 card-tabs-button" variant="primary">
      ...
      <template #modal-footer>
        <div class="w-100">
          <b-button variant="success" size="sm" class="float-right m-1" @click="sendReview">
            {{ $t('actions.send') }}
          </b-button>
          <b-button
              variant="danger"
