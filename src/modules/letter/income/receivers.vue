            ...
            <tbody>
              ...
              >
                ...
                <td>
                  ...
                  <div v-if="item.isForCommission">
                    <div class="mt-1 mb-0 p-2 badge badge-info">
            ...
            <tbody v-if="selectedAgreement.length > 0">
              ...
              >
                ...
                <td>
                  ...
                  <div v-if="member.isForCommission">
                    <div class="mt-1 mb-0 p-2 badge badge-info">
                      {{ $t("submodules.commission.doc_status.send_for_commission") }}
                    </div>
                  </div>
