  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('word_templates.organizations') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
              ...
              <p>
                {{
                  getName({
                    ...
                    nameLt: data.item.nameLt,
                    nameUz: data.item.nameUz
                  })
                }}
              </p>
            </template>
...
export default {
  ...
  data() {
    return {
      ...
      tableFields: [
        ...
        {
          label: this.$t('submodules.final_forecast.organization_name'),
          key: "name",
          thClass: "text-center",
          tdClass: "text-center"
        },
        ...
        {
          label: this.$t('submodules.doc.email'),
          key: "email",
          thClass: "text-center",
          tdClass: "text-center"
        },
  ...
  methods: {
    ...
    editItem(id) {
      this.$router.push({name: 'UpdateOrganizations', params: {id: id}})
    },
