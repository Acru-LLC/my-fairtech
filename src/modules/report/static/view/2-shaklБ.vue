      ...
      <table cellspacing="0" border="0" class="table-nowrap">
        ...
        <tr>
          <td colspan="15" align="center" valign="middle">
            <b
              ><font size="4"
                >Тошкент давлат юридик университетининг Ихтисослаштирилган филиали раҳбарияти томонидан жисмоний шахсларни шахсий қабул қилиш тўғрисида</font
              ></b
            >
          </td>
        </tr>
        ...
        <tr>
          <td colspan="15" align="center" valign="middle">
            <font size="3"
              >(1-қатор 2-5-қаторлар йиғиндисига, 6-қатор йиғиндиси 7-12 қаторлар йиғиндисига, 1 ва 2-устунлар йиғиндиси 4, 8, 9, 12-устунлар йиғиндисига, 4-устун 5, 6, 7-устунлар йиғиндисига тенг)</font
            >
          </td>
        </tr>
        <tr>
...
import {rowsShakl2B} from "../../organizitional/static"
export default {
  components: {
    Checkbox,
  },
