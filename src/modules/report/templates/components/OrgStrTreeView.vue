<template>
  <li>
    <div class="hoverable">
      ...
      >
        <template v-if="isFolder">
          <i
              ...
              :class="open ? 'mdi-domain' : 'mdi-office-building'"
          />
        </template>
        <template v-else>
        ...
        <p
            :class="members.includes(departmentForTree.id) ? 'active':''   "
            class="dep-name "
      ...
      <!-- ACTIONS -->
      <div>
        <i v-if="members.includes(departmentForTree.id)" class="mdi mdi-check-decagram delete text-primary"></i>
      </div>
