    ...
    <b-row class="mb-3">
      ...
      >
        <BaseInputWithValidation
            rules="required"
            class="required"
            v-model="editingItem.regionalAdministration"
            :label="$t('send_message.regionalAdministration')"
            :placeholder="$t('send_message.regionalAdministration')"
        />
      </b-col>
      <b-col
          sm="12"
    ...
    <b-row class="mb-3">
      ...
      >
        <BaseInputWithValidation
            ...
            :label="$t('send_message.address')"
            :placeholder="$t('send_message.address')"
        />
      </b-col>
      <b-col
          sm="12"
...
export default {
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.customIsModeCreate ? this.customIsModeCreate : this.$route.name === 'CreateRegionalAdministrations'
    },
    computedObserver() {
    ...
    if (this.isModeCreate) {
      await crudAndListsService.getEmpty(MAIN_API_URL)
          .then(res => {
            ...
            this.editingItem.isRepublic = false
