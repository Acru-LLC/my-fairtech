  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('send_message.regions') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
  ...
  data() {
    return {
      ...
      tableFields: [
        ...
        {label: this.$t('send_message.regionalAdministration'), key: "regionalAdministration"},
        {label: this.$t('send_message.address'), key: "address"},
        {label: this.$t('send_message.phone_number'), key: "phoneNumber"},
