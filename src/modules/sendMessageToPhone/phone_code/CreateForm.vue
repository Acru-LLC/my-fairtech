    ...
    <b-row class="mb-3">
      ...
      >
        <BaseInputWithValidation
            ...
            :label="$t('send_message.phone_code')"
            :placeholder="$t('send_message.phone_code')"
        />
      </b-col>
      <b-col
          sm="12"
...
export default {
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.customIsModeCreate ? this.customIsModeCreate : this.$route.name === 'CreatePhoneCode'
    },
    computedObserver() {
