      ...
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
            ...
            <div class="col-sm-3" v-if="tableItems.length > 0">
              <h4><strong>{{ $t('column.passport_number') }} №{{ tableItems[0].constructionPassportNumber }}</strong></h4>
            </div>
            <!-- end col-->
          </div>
...
export default {
  ...
  data() {
    return {
      ...
      tableFields: [
        ...
        {label: i18n.t('column.created_date'), key: "ownerName"},
  ...
  methods: {
    ...
    fetchTableItems() {
      ...
      crudAndListsService.searchListWithoutKeyword(MAIN_API_URL, this.var_default_search_payload, this.$route.params.adId, true, 'all')
          .then((res) => {
