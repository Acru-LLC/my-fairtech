  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.contractor_notification.income_list') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
              ...
              <div class="text-sm-end">
                <div class="text-sm-end justify-content-end">
                  <download-excel
                      :data="json_data"
                      :fields="json_fields"
                      header="Қабул қилинган билдиришномалар"
                      worksheet="My Worksheet"
                      name="Қабул_қилинган_билдиришномалар.xls"
                  >
                    <b-btn
                        @click="downloadExcel"
                        type="button"
...
export default {
  data() {
    return {
      json_fields: {
        ...
        [this.$t('column.from_whom')]: "ownerName",
  ...
  methods: {
    ...
    fetchTableItems() {
      ...
      crudAndListsService
          .searchListIncomeNotification(MAIN_API_URL, this.var_default_search_payload)
          .then((res) => {
