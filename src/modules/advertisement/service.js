...
export default {
    getSearchResultList(searchData){
        return ApiService.post(`/pharm/filtr-search?tin=${searchData.data.stir}&fio=${searchData.data.customerName}&phone=${searchData.data.customerNumber}&region=${searchData.data.searchRegion}&district=${searchData.data.street}&mnumber=${searchData.data.appeal}&date1=${searchData.data.startDate}&date2=${searchData.data.endDate}&status=${searchData.data.appealPosition}`, searchData.params.params)
    },
    getDataAllInMonth(monthwithYear, withLoader = false) {
        return ApiService.getFile(
            `pharm-big/month?month=${monthwithYear}`, withLoader)
    },
    getDataAllInMonthChakana(monthwithYear, withLoader = false) {
        return ApiService.getFile(
            `pharm/month?month=${monthwithYear}`, withLoader)
    },
    ...
    // PHARM SERVICE
    // getListPharmUlgurji(data) {
    //     return ApiService.post(`/pharm-big/list-search?keyword=${data.search}&status=${data.status}`, data.params)
    // },
    // PHARM SERVICE
    getListPharmMonitor(data) {
        return ApiService.post(`/pharm/searchOutside?keyword=${data.search}&status=${data.status}`, data.params)
    },
    ...
    getQrScanInfoById(mNumber) {
        return ApiService.post(`/pharm/qr-scan?code=${mNumber}`)
    },
    setRepeatMessageFromUser(data) {
        return ApiService.post(`/pharm/pharm-sms/confirm-answer`, data)
    },
    getDoerAppealList(data) {
        return ApiService.post(`/pharm/doer/list-search?keyword=${data.search}&status=${data.status}`, data.params)
    },
    getByIdApplicationInfo: function (id, withLoader = false) {
        return ApiService.get(`/pharm/outer/get/${id}`, withLoader)
    },
    ...
    updateFileEntity: function (url, payload) {
    ...
    editStatusApplication: function (code, id) {
        return ApiService.post(`pharm/edit-status?status=${code}&id=${id}`);
    },
    sendSmsToUser: function (id) {
        return ApiService.post(`pharm/pharm-sms/sendMsg?id=${id}`);
    },
    getAllApplicationExcelData({inn, date_from, date_to}, withLoader = false) {
        return ApiService.get(`pharm/for-excel?inn=${inn}&date_from=${date_from}&date_to=${date_to}`, withLoader)
    },
...
// Ulgurji
    ...
    // PHARM SERVICE
    getListPharmMonitorUlgurji(data) {
        return ApiService.post(`/pharm-big/list-search?keyword=${data.search}&status=${data.status}`, data.params)
    },
    getListPharmMonitorCreatedUlgurji(data) {
        return ApiService.post(`/pharm-big/listByStatus?keyword=${data.search}`, data.params)
    },
    getByIdPharmAppealsUlgurji(application_id, department_id) {
        return ApiService.post(`application-dxa/receive?id=${application_id}&department_id=${department_id ? department_id : ''}`)
    },
    setEmployeesAttachchedToAppealUlgurji(data) {
        return ApiService.post(`/pharm-big/doer/attached-employee`, data)
    },
    setRegionAttachchedToAppealUlgurji(data) {
        return ApiService.post(`/pharm-big/pharm-attached/attached-department?id=${data.pharmId}&depId=${data.regionId}`, data)
    },
    getUserAppealInfoByIdUlgurji(mNumber) {
        return ApiService.post(`/pharm-big/pharm-sms/confirm?mNumber=${mNumber}`)
    },
    getQrScanInfoByIdUlgurji(mNumber) {
        return ApiService.post(`/pharm-big/qr-scan?code=${mNumber}`)
    },
    setRepeatMessageFromUserUlgurji(data) {
        return ApiService.post(`/pharm-big/pharm-sms/confirm-answer`, data)
    },
    getDoerAppealListUlgurji(data) {
        return ApiService.post(`/pharm-big/doer/list-search?keyword=${data.search}&status=${data.status}`, data.pg)
    },
    getByIdApplicationInfoUlgurji: function (id, withLoader = false) {
        return ApiService.get(`/pharm-big/get/${id}`, withLoader)
    },
    getUserApplicationInfoUlgurji: function (id, withLoader = false) {
        return ApiService.get(`/pharm-big/doer/get-pdf-by-id/${id}`, withLoader)
    },

    leaveFileUlgurji: function (id, cmt, file, code) {
        let bodyFormData = new FormData();
        bodyFormData.append('file', file)
        bodyFormData.append('comment', cmt)
        bodyFormData.append('pharmId', id)
        bodyFormData.append('sector_code', code)
        return ApiService.formDataFile(`/pharm-big/doer/attachedFile-create`, bodyFormData)
    },
    listFilesUlgurji: function (pharmId, search, code, data) {
        return ApiService.post(`/pharm-big/doer/list-pharmId/${pharmId}?code=${code}&search=${search}`, data)
    },
    downloadFileDocUlgurji: function (code, payload) {
        return ApiService.get(`pharm-big/file/download?code=${code}`, payload);
    },
    editStatusApplicationUlgurji: function (code, id) {
        return ApiService.post(`pharm-big/edit-status?status=${code}&id=${id}`);
    },
    sendSmsToUserUlgurji: function (id) {
        return ApiService.post(`pharm/pharm-sms/sendMsg?id=${id}`);
    },
    getAllApplicationExcelDataUlgurji({inn, date_from, date_to, soato}, withLoader = false) {
        return ApiService.get(`pharm-big/for-excel?inn=${inn}&date1=${date_from}&date2=${date_to}&soato=${soato}`, withLoader)
    },
    acceptSenderRegionUlgurji(application_id, department_id) {
        return ApiService.post(`application-dxa/receive?id=${application_id}&department_id=${department_id ? department_id : ''}`)
    },
    ...
    getPharmStatusCountDtoBigDoer() {
        return ApiService.get(`/pharm-big/doer/get/status-count`)
    },
    sendRequestToPharmacy(pharmIds) {
        return ApiService.post(`/pharm/pharm-sms/sendMsg-to-pharmacy?pharmIds=${pharmIds}`)
    }
    // listFiles: function (pharmId, keyword) {
    //     return ApiService.post(`/pharm/doer/list-file?keyword=${keyword}&pharmId=${pharmId}`)
    // },
