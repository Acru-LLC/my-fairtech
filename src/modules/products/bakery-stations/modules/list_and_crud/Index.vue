  ...
  <div class="row">
    <div class="col-12">
      <div class="col-md-12 text-center">
        <div class="h4 mb-4 d-inline-block">{{ $t('submodules.bakery_stations.title') }}</div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="row mb-2">
...
export default {
  ...
  data() {
    return {
      ...
      tableFields: [
        ...
        {
          label: this.$t('submodules.bakery_stations.bakery_station_owner'),
          key: "contractorName"
        },
        {
          label: this.$t('submodules.bakery_stations.bakery_station_owner_inn'),
          key: "inn"
        },
        {
  ...
  methods: {
    ...
    fetchTableItems(name) {
      ...
      crudAndListsService
          .searchListWithKeywordForBakeryStations(MAIN_API_URL, this.var_default_search_payload, null, true)
          .then((res) => {
