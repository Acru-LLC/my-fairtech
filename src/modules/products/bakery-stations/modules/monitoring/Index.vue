                  ...
                  >
                    <v-popup :ref="`ad-details-popup-${l.id}`">
                      <template v-if="!l.details">
                        <h4 class="m-0"><strong>{{ $t('submodules.bakery_stations.name') }}</strong>
                        </h4>
                      ...
                      <template v-else>
                        <div class="ad-details-wrapper">
                          <h4 class="m-0 mb-1">
                            {{ $t('submodules.bakery_stations.name') }} - <strong> <i>{{
                              ...
                              <table class="ad-details">
                                ...
                                <tr>
                                  <th
                                      rowspan="8"
                                      width="10%"
                                  >{{ $t('submodules.bakery_stations.name') }}
                                  </th>
                                </tr>
                                <tr>
                                  <th
...
export default {
  ...
  created() {
    ...
    // GET REGIONS
    helperService.fetchRegionsForBakeryByCurrentUserId()
        .then(res => {
  ...
  methods: {
    ...
    search() {
      helperService.getBakeryStationsForMap(this.filterPayload, true)
          .then(res => {
            this.adMarkers = []
