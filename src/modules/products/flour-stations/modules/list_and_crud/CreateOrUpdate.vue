      ...
      <b-row class="mb-3">
        ...
        >
          <BaseInputWithValidation
              ...
              mask="#########"
              :label="$t('submodules.flour_stations.flour_station_owner_inn')"
              with-input-append
          >
        ...
        >
          <BaseMultiselectWithValidation
              ...
              :label="$t('submodules.flour_stations.flour_station_owner')"
              placeholder=""
      ...
      <b-row class="mb-3">
        ...
        >
          <BaseInputWithValidation
              ...
              :label="$t('submodules.flour_stations.flour_station_owner_phone_number')"
              mask="+998#########"
          />
        </b-col>
        ...
        >
          <BaseTextareaWithValidation
              ...
              max-rows="2"
              :label="$t('submodules.flour_stations.flour_station_owner_address')"
          />
        </b-col>
      </b-row>
      ...
      <b-row class="mb-3">
        <b-col cols="12">
          <h5 class="m-0 text-center">
            {{ $t('submodules.flour_stations.flour_station_exact_address') }}
          </h5>
          <hr>
        </b-col>
        <b-col
...
export default {
  ...
  * COMPUTED */
  computed: {
    ...
    isModeCreate() {
      return this.$route.name == 'CreateFlourStation'
    },
    computedObserver() {
