                  ...
                  >
                    <v-popup :ref="`ad-details-popup-${l.id}`">
                      <template v-if="!l.details">
                        <h4 class="m-0"><strong>{{ $t('submodules.flour_stations.name') }}</strong>
                        </h4>
                      ...
                      <template v-else>
                        <div class="ad-details-wrapper">
                          <h4 class="m-0 mb-1">
                            {{ $t('submodules.flour_stations.name') }} - <strong> <i>{{
                              currentAdDetails.name
                            }}</i></strong>
                          </h4>
                          <b-row>
                            <b-col
                              ...
                              <table class="ad-details">
                                ...
                                <tr>
                                  <th
                                      rowspan="8"
                                      width="10%"
                                  >{{ $t('submodules.flour_stations.name') }}
                                  </th>
                                </tr>
                                <tr>
                                  <th
                                ...
                                <tr>
                                  <th
                                      scope="row"
                                      width="10%"
                                  >{{ $t('column.construction.phone_number') }}
                                  </th>
                                ...
                                <tr>
                                  ...
                                  <td colspan="2">
                                    ...
                                    {{
                                      ...
                                      v-if="currentAdDetails.addressDto.quarterNameUz || currentAdDetails.addressDto.additional">,</span>
                                    {{
...
export default {
  ...
  created() {
    ...
    // GET REGIONS
    helperService.fetchRegionsForFlourByCurrentUserId()
        .then(res => {
  ...
  methods: {
    ...
    search() {
      helperService.getFlourStationsForMap(this.filterPayload, true)
          .then(res => {
            this.adMarkers = []
