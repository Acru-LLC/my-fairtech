                  ...
                  >
                    <v-popup :ref="`ad-details-popup-${l.id}`">
                      <template v-if="!l.details">
                        <h4 class="m-0"><strong>{{ $t('submodules.sugar_stations.name') }}</strong>
                        </h4>
                      ...
                      <template v-else>
                        <div class="ad-details-wrapper">
                          <h4 class="m-0 mb-1">
                            {{ $t('submodules.sugar_stations.name') }} - <strong> <i>{{
                              ...
                              <table class="ad-details">
                                ...
                                <tr>
                                  <th
                                      rowspan="8"
                                      width="10%"
                                  >{{ $t('submodules.sugar_stations.name') }}
                                  </th>
                                </tr>
                                <tr>
                                  <th
...
export default {
  ...
  created() {
    ...
    // GET REGIONS
    helperService.fetchRegionsForSugarByCurrentUserId()
        .then(res => {
  ...
  methods: {
    ...
    search() {
      helperService.getSugarStationsForMap(this.filterPayload, true)
          .then(res => {
            this.adMarkers = []
