...
<script>
const MAIN_API_URL = 'directory/contractor-status'
/*
...
export default {
  name: "CreateFormContractorStatus",
  props: {
    customIsModeCreate: {
      type: Boolean,
      default: false
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.customIsModeCreate ? this.customIsModeCreate : this.$route.name === 'CreateContractorStatus'
    },
    computedObserver() {
