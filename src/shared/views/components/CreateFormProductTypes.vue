...
<script>
const MAIN_API_URL = 'directory/product-type'
/*
...
export default {
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.customIsModeCreate ? this.customIsModeCreate : this.$route.name === 'CreateProductType'
    },
    computedObserver() {
