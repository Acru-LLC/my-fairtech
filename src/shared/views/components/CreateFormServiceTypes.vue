...
<script>
const MAIN_API_URL = 'directory/service-type'
/*
...
export default {
  ...
  * COMPUTED */
  computed: {
    isModeCreate() {
      return this.customIsModeCreate ? this.customIsModeCreate : this.$route.name === 'CreateServiceType'
    },
    computedObserver() {
