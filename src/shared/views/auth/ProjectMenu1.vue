          ...
          <div class="row">
            <div class="col-xs-12 col-md-offset-1 col-md-10 col-lg-offset-2 col-lg-8">
              <div class="page-title  home text-center">
                                  <span class="heading-page"> Fair Tech yagona axborat tizimiga hush kelibsiz
                                  </span>
                <p class="mt20">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                  incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
              </div>
              <div class="hexagon-menu clear">
                <div class="all">
                  <div class="lefter">
                    <div class="text">Pharm Info</div>
                  </div>
                  <div class="left">
                    <div class="text">Product Info</div>
                  </div>
                  <div class="center">
                    <div class="explainer"><span>Fair Tech</span></div>
                    <div class="text">Fair Tech</div>
                  </div>
                  <div class="right">
                    <div class="text">Fair Price</div>
                  </div>
                  <div class="righter">
                    <div class="text">Other Projects</div>
                  </div>
                </div>
              </div>
            </div>
