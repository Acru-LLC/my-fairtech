...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "O", function() { return toHandlerKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "P", function() { return toNumber; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Q", function() { return toRawType; });
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "Froala", function() { return /* binding */ Froala; });
__webpack_require__.d(__webpack_exports__, "FroalaView", function() { return /* binding */ FroalaView; });
...
const builtInSymbols = new Set(
  /* @__PURE__ */ Object.getOwnPropertyNames(Symbol).filter((key) => key !== "arguments" && key !== "caller").map((key) => Symbol[key]).filter(shared_esm_bundler["G" /* isSymbol */])
);
...
const shallowReactiveHandlers = /* @__PURE__ */ Object(shared_esm_bundler["h" /* extend */])(
  {},
  mutableHandlers,
  {
    get: shallowGet,
...
const shallowReadonlyHandlers = /* @__PURE__ */ Object(shared_esm_bundler["h" /* extend */])(
  {},
  readonlyHandlers,
  {
...
function reactivity_esm_bundler_get(target, key, isReadonly = false, isShallow = false) {
...
function reactivity_esm_bundler_has(key, isReadonly = false) {
...
function createInstrumentationGetter(isReadonly, shallow) {
  ...
  return (target, key, receiver) => {
    ...
    return Reflect.get(
      Object(shared_esm_bundler["k" /* hasOwn */])(instrumentations, key) && key in target ? instrumentations : target,
      key,
      receiver
    );
  };
...
function checkIdentityKeys(target, has2, key) {
  ...
  if (rawKey !== key && has2.call(target, rawKey)) {
    const type = Object(shared_esm_bundler["Q" /* toRawType */])(target);
    console.warn(
...
function getTargetType(value) {
  return value["__v_skip"] || !Object.isExtensible(value) ? 0 /* INVALID */ : targetTypeMap(Object(shared_esm_bundler["Q" /* toRawType */])(value));
}
...
function runtime_core_esm_bundler_emit(instance, event, ...rawArgs) {
  ...
  if (false) {}
  let handlerName;
  let handler = props[handlerName = Object(shared_esm_bundler["O" /* toHandlerKey */])(event)] || // also try camelCase event handler (#2249)
  props[handlerName = Object(shared_esm_bundler["O" /* toHandlerKey */])(Object(shared_esm_bundler["e" /* camelize */])(event))];
  if (!handler && isModelListener) {
    handler = props[handlerName = Object(shared_esm_bundler["O" /* toHandlerKey */])(Object(shared_esm_bundler["l" /* hyphenate */])(event))];
  }
  if (handler) {
    ...
    if (vnode.shapeFlag & 4) {
      ...
      result = normalizeVNode(
        render2.length > 1 ? render2(
          props,
           false ? undefined : { attrs, slots, emit }
        ) : render2(
          props,
          null
...
function createSuspenseBoundary(vnode, parentSuspense, parentComponent, container, hiddenContainer, anchor, isSVG, slotScopeIds, optimized, rendererInternals, isHydrating = false) {
  ...
  const timeout = vnode.props ? Object(shared_esm_bundler["P" /* toNumber */])(vnode.props.timeout) : void 0;
  if (false) {}
  const suspense = {
    vnode,
  ...
  const job = () => {
    ...
    if (cb) {
      ...
      if (deep || forceTrigger || (isMultiSource ? newValue.some(
        (v, i) => Object(shared_esm_bundler["j" /* hasChanged */])(v, oldValue[i])
      ) : Object(shared_esm_bundler["j" /* hasChanged */])(newValue, oldValue)) || false) {
        if (cleanup) {
          cleanup();
        }
        callWithAsyncErrorHandling(cb, instance, 3, [
...
function defineComponent(options, extraOptions) {
  return Object(shared_esm_bundler["q" /* isFunction */])(options) ? (
    ...
    /* @__PURE__ */ (() => Object(shared_esm_bundler["h" /* extend */])({ name: options.name }, extraOptions, { setup: options }))()
  ) : options;
}
...
function resolveAsset(type, name, warnMissing = true, maybeSelfReference = false) {
  ...
  if (instance) {
    ...
    const res = (
      ...
      runtime_core_esm_bundler_resolve(instance[type] || Component[type], name) || // global registration
...
function toHandlers(obj, preserveCaseIfNecessary) {
  ...
  for (const key in obj) {
    ret[preserveCaseIfNecessary && /[A-Z]/.test(key) ? `on:${key}` : Object(shared_esm_bundler["O" /* toHandlerKey */])(key)] = obj[key];
  }
  return ret;
}
...
const publicPropertiesMap = (
  ...
  /* @__PURE__ */ Object(shared_esm_bundler["h" /* extend */])(/* @__PURE__ */ Object.create(null), {
    $: (i) => i,
    $el: (i) => i.vnode.el,
    $data: (i) => i.data,
...
if (false) {}
const RuntimeCompiledPublicInstanceProxyHandlers = /* @__PURE__ */ Object(shared_esm_bundler["h" /* extend */])(
  {},
...
function normalizePropsOrEmits(props) {
  return Object(shared_esm_bundler["o" /* isArray */])(props) ? props.reduce(
...
function mergeModels(a, b) {
  if (!a || !b)
    return a || b;
  if (Object(shared_esm_bundler["o" /* isArray */])(a) && Object(shared_esm_bundler["o" /* isArray */])(b))
    return a.concat(b);
...
function runtime_core_esm_bundler_callHook(hook, instance, type) {
  callWithAsyncErrorHandling(
    Object(shared_esm_bundler["o" /* isArray */])(hook) ? hook.map((h) => h.bind(instance.proxy)) : hook.bind(instance.proxy),
    instance,
    type
  );
}
...
function mergeDataFn(to, from) {
  ...
  return function mergedDataFn() {
    return (Object(shared_esm_bundler["h" /* extend */]))(
      Object(shared_esm_bundler["q" /* isFunction */])(to) ? to.call(this, this) : to,
      Object(shared_esm_bundler["q" /* isFunction */])(from) ? from.call(this, this) : from
    );
  };
}
...
function updateProps(instance, rawProps, rawPrevProps, optimized) {
  ...
  if (
    ...
    for (const key in rawCurrentProps) {
      ...
      !Object(shared_esm_bundler["k" /* hasOwn */])(rawProps, key) && // it's possible the original props was passed in as kebab-case
  ...
  if (needCastKeys) {
    ...
    for (let i = 0; i < needCastKeys.length; i++) {
      ...
      props[key] = resolvePropValue(
        ...
        castValues[key],
        instance,
        !Object(shared_esm_bundler["k" /* hasOwn */])(castValues, key)
      );
    }
  }
...
function normalizePropsOptions(comp, appContext, asMixin = false) {
  ...
  if (Object(shared_esm_bundler["o" /* isArray */])(raw)) {
    ...
    for (const key in raw) {
      ...
      if (validatePropName(normalizedKey)) {
        const opt = raw[key];
        const prop = normalized[normalizedKey] = Object(shared_esm_bundler["o" /* isArray */])(opt) || Object(shared_esm_bundler["q" /* isFunction */])(opt) ? { type: opt } : Object(shared_esm_bundler["h" /* extend */])({}, opt);
        if (prop) {
...
function validateProps(rawProps, props, instance) {
  ...
  for (const key in options) {
    ...
    validateProp(
      ...
      resolvedValues[key],
      opt,
      !Object(shared_esm_bundler["k" /* hasOwn */])(rawProps, key) && !Object(shared_esm_bundler["k" /* hasOwn */])(rawProps, Object(shared_esm_bundler["l" /* hyphenate */])(key))
    );
  }
}
...
const isSimpleType = /* @__PURE__ */ Object(shared_esm_bundler["K" /* makeMap */])(
...
function getInvalidTypeMessage(name, value, expectedTypes) {
  ...
  const receivedType = Object(shared_esm_bundler["Q" /* toRawType */])(value);
...
function setRef(rawRef, oldRawRef, parentSuspense, vnode, isUnmount = false) {
  if (Object(shared_esm_bundler["o" /* isArray */])(rawRef)) {
    rawRef.forEach(
      (r, i) => setRef(
        r,
        oldRawRef && (Object(shared_esm_bundler["o" /* isArray */])(oldRawRef) ? oldRawRef[i] : oldRawRef),
        parentSuspense,
        vnode,
        isUnmount
      )
...
const normalizeRef = ({
  ...
  return ref != null ? Object(shared_esm_bundler["F" /* isString */])(ref) || isRef(ref) || Object(shared_esm_bundler["q" /* isFunction */])(ref) ? { i: currentRenderingInstance, r: ref, k: ref_key, f: !!ref_for } : ref : null;
};
...
function cloneVNode(vnode, extraProps, mergeRef = false) {
  ...
  const cloned = {
    ...
    ref: extraProps && extraProps.ref ? (
      ...
      mergeRef && ref ? Object(shared_esm_bundler["o" /* isArray */])(ref) ? ref.concat(normalizeRef(extraProps)) : [ref, normalizeRef(extraProps)] : normalizeRef(extraProps)
    ) : ref,
...
function setupStatefulComponent(instance, isSSR) {
  ...
  if (setup) {
    ...
    const setupResult = callWithErrorHandling(
      ...
      instance,
      0,
      [ false ? undefined : instance.props, setupContext]
    );
    resetTracking();
    unsetCurrentInstance();
  ...
  if (!instance.render) {
    if (!isSSR && compile && !Component.render) {
      ...
      if (template) {
        ...
        const finalCompilerOptions = Object(shared_esm_bundler["h" /* extend */])(
  ...
  if (Object(shared_esm_bundler["o" /* isArray */])(val)) {
    ...
    if (name.startsWith("--")) {
      ...
      if (importantRE.test(val)) {
        style.setProperty(
          Object(shared_esm_bundler["l" /* hyphenate */])(prefixed),
...
class runtime_dom_esm_bundler_VueElement extends BaseClass {
        ...
        for (const key in props) {
          ...
          if (opt === Number || opt && opt.type === Number) {
            if (key in this._props) {
              this._props[key] = Object(shared_esm_bundler["P" /* toNumber */])(this._props[key]);
            }
  ...
  _setAttr(key) {
    ...
    if (this._numberProps && this._numberProps[camelKey]) {
      value = Object(shared_esm_bundler["P" /* toNumber */])(value);
    }
...
const TransitionPropsValidators = Transition.props = /* @__PURE__ */ Object(shared_esm_bundler["h" /* extend */])(
  {},
...
function NumberOf(val) {
  const res = Object(shared_esm_bundler["P" /* toNumber */])(val);
  if (false) {}
  return res;
}
  ...
  created(el, { value, modifiers: { number } }, vnode) {
    ...
    addEventListener(el, "change", () => {
      const selectedVal = Array.prototype.filter.call(el.options, (o) => o.selected).map(
        (o) => number ? Object(shared_esm_bundler["J" /* looseToNumber */])(getValue(o)) : getValue(o)
      );
      el._assign(
...
var Froala = defineComponent({
  ...
  render: function render() {
    return h(this.currentTag, [this.$slots["default"] ? this.$slots["default"]()[0] : null]);
  },
...
var FroalaView = defineComponent({
  props: ['tag', 'value'],
  watch: {
